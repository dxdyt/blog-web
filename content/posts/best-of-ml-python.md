...
date: 2025-10-24T12:23:22+08:00
draft: False
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 5K · 🔀 75K · 📦 540K · 📋 42K - 4% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/tensorflow/tensorflow
	```
- [PyPi](https://pypi.org/project/tensorflow) (📥 25M / month · 📦 9.5K · ⏱️ 13.08.2025):
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 6K · 🔀 26K · 📥 110K · 📦 830K · 📋 56K - 30% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/torch) (📥 68M / month · 📦 29K · ⏱️ 15.10.2025):
	```
	pip install torch
	```
...
- [GitHub](https://github.com/scikit-learn/scikit-learn) (👨‍💻 3.4K · 🔀 26K · 📥 1.1K · 📦 1.3M · 📋 12K - 17% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.4K · 🔀 20K · 📦 300K · 📋 13K - 2% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 18M / month · 📦 2K · ⏱️ 21.08.2025):
	```
	pip install keras
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 670 · 🔀 8.8K · 📥 20K · 📦 170K · 📋 5.6K - 8% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 32M / month · 📦 2.9K · ⏱️ 21.10.2025):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/PaddlePaddle/Paddle) (👨‍💻 1.4K · 🔀 5.9K · 📥 15K · 📦 8.8K · 📋 20K - 8% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/PaddlePaddle/Paddle
	```
- [PyPi](https://pypi.org/project/paddlepaddle) (📥 1.6M / month · 📦 270 · ⏱️ 08.09.2025):
	```
...
- [GitHub](https://github.com/Lightning-AI/pytorch-lightning) (👨‍💻 1K · 🔀 3.6K · 📥 15K · 📦 48K · 📋 7.4K - 11% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/Lightning-AI/lightning
	```
- [PyPi](https://pypi.org/project/pytorch-lightning) (📥 12M / month · 📦 1.8K · ⏱️ 05.09.2025):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 470 · 🔀 3.3K · 📥 36 · 📦 180K · 📋 5.8K - 50% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 23M / month · 📦 5.6K · ⏱️ 07.07.2025):
	```
...
- [GitHub](https://github.com/apache/spark) (👨‍💻 3.3K · 🔀 29K · ⏱️ 23.10.2025):

	```
	git clone https://github.com/apache/spark
	```
- [PyPi](https://pypi.org/project/pyspark) (📥 47M / month · 📦 2.1K · ⏱️ 28.09.2025):
	```
	pip install pyspark
	```
...
- [GitHub](https://github.com/microsoft/LightGBM) (👨‍💻 330 · 🔀 3.9K · 📥 310K · 📦 56K · 📋 3.6K - 12% open · ⏱️ 20.10.2025):
...
- [GitHub](https://github.com/catboost/catboost) (👨‍💻 1.4K · 🔀 1.2K · 📥 460K · 📦 19 · 📋 2.5K - 25% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/catboost) (📥 5.2M / month · 📦 650 · ⏱️ 13.04.2025):
	```
...
- [GitHub](https://github.com/fastai/fastai) (👨‍💻 680 · 🔀 7.6K · 📦 23K · 📋 1.9K - 13% open · ⏱️ 05.09.2025):

	```
	git clone https://github.com/fastai/fastai
	```
- [PyPi](https://pypi.org/project/fastai) (📥 650K / month · 📦 340 · ⏱️ 19.08.2025):
	```
	pip install fastai
	```
</details>
...
- [GitHub](https://github.com/apache/flink) (👨‍💻 2K · 🔀 14K · 📦 21 · ⏱️ 23.10.2025):

	```
	git clone https://github.com/apache/flink
	```
- [PyPi](https://pypi.org/project/apache-flink) (📥 520K / month · 📦 37 · ⏱️ 25.09.2025):
	```
...
- [GitHub](https://github.com/google/flax) (👨‍💻 280 · 🔀 740 · 📥 61 · 📦 15K · 📋 1.3K - 34% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/google/flax
	```
- [PyPi](https://pypi.org/project/flax) (📥 2.2M / month · 📦 740 · ⏱️ 25.09.2025):
	```
	pip install flax
	```
...
- [GitHub](https://github.com/pytorch/ignite) (👨‍💻 990 · 🔀 660 · 📦 3.9K · 📋 1.4K - 10% open · ⏱️ 16.10.2025):

	```
	git clone https://github.com/pytorch/ignite
	```
- [PyPi](https://pypi.org/project/pytorch-ignite) (📥 190K / month · 📦 120 · ⏱️ 23.10.2025):
	```
...
- [GitHub](https://github.com/arogozhnikov/einops) (👨‍💻 34 · 🔀 380 · 📦 82K · 📋 200 - 17% open · ⏱️ 12.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/einops) (📥 14M / month · 📦 2.6K · ⏱️ 09.02.2025):
	```
	pip install einops
	```
...
- [GitHub](https://github.com/ivy-llc/ivy) (👨‍💻 1.5K · 🔀 5.6K · 📋 17K - 5% open · ⏱️ 10.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/ivy) (📥 37K / month · 📦 16 · ⏱️ 16.06.2025):
	```
	pip install ivy
	```
</details>
...
- [GitHub](https://github.com/jina-ai/serve) (👨‍💻 180 · 🔀 2.2K · ⏱️ 24.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/jina) (📥 130K / month · 📦 29 · ⏱️ 24.03.2025):
	```
	pip install jina
	```
...
- [GitHub](https://github.com/mlpack/mlpack) (👨‍💻 340 · 🔀 1.7K · 📋 1.7K - 1% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/mlpack/mlpack
	```
- [PyPi](https://pypi.org/project/mlpack) (📥 6.3K / month · 📦 6 · ⏱️ 22.05.2025):
	```
	pip install mlpack
	```
...
- [GitHub](https://github.com/ludwig-ai/ludwig) (👨‍💻 160 · 🔀 1.2K · 📦 340 · 📋 1.1K - 4% open · ⏱️ 17.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/ludwig) (📥 3.9K / month · 📦 6 · ⏱️ 30.07.2024):
	```
	pip install ludwig
	```
</details>
...
- [GitHub](https://github.com/skorch-dev/skorch) (👨‍💻 68 · 🔀 400 · 📦 1.7K · 📋 540 - 12% open · ⏱️ 15.08.2025):

	```
	git clone https://github.com/skorch-dev/skorch
	```
- [PyPi](https://pypi.org/project/skorch) (📥 160K / month · 📦 110 · ⏱️ 08.08.2025):
	```
	pip install skorch
	```
...
<details><summary><b><a href="https://github.com/google-deepmind/dm-haiku">Haiku</a></b> (🥉32 ·  ⭐ 3.1K) - JAX-based neural network library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/google-deepmind/dm-haiku) (👨‍💻 90 · 🔀 260 · 📦 2.6K · 📋 250 - 29% open · ⏱️ 29.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/dm-haiku) (📥 280K / month · 📦 200 · ⏱️ 18.09.2025):
	```
...
- [GitHub](https://github.com/google-deepmind/sonnet) (👨‍💻 61 · 🔀 1.3K · 📦 1.5K · 📋 190 - 16% open · ⏱️ 04.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dm-sonnet) (📥 42K / month · 📦 19 · ⏱️ 02.01.2024):
	```
...
- [GitHub](https://github.com/ROCm/tensorflow-upstream) (👨‍💻 5K · 🔀 100 · 📥 31 · 📋 400 - 3% open · ⏱️ 16.10.2025):

	```
	git clone https://github.com/ROCmSoftwarePlatform/tensorflow-upstream
	```
- [PyPi](https://pypi.org/project/tensorflow-rocm) (📥 1.9K / month · 📦 9 · ⏱️ 10.01.2024):
	```
...
- [GitHub](https://github.com/geomstats/geomstats) (👨‍💻 97 · 🔀 260 · 📦 150 · 📋 570 - 36% open · ⏱️ 06.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/geomstats) (📥 17K / month · 📦 12 · ⏱️ 09.09.2024):
	```
...
<details><summary><b><a href="https://github.com/numenta/nupic-legacy">NuPIC</a></b> (🥉28 ·  ⭐ 6.4K · 💤) - Numenta Platform for Intelligent Computing is an implementation of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/numenta/nupic-legacy) (👨‍💻 120 · 🔀 1.5K · 📥 26 · 📦 21 · 📋 1.8K - 25% open · ⏱️ 03.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 1.1K / month · ⏱️ 01.09.2016):
	```
	pip install nupic
	```
</details>
...
- [GitHub](https://github.com/pyRiemann/pyRiemann) (👨‍💻 38 · 🔀 170 · 📦 480 · 📋 110 - 2% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyriemann) (📥 94K / month · 📦 31 · ⏱️ 23.07.2025):
	```
...
- [GitHub](https://github.com/determined-ai/determined) (👨‍💻 120 · 🔀 360 · 📥 7.8K · 📋 450 - 22% open · ⏱️ 20.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/determined) (📥 32K / month · 📦 4 · ⏱️ 19.03.2025):
	```
...
- [GitHub](https://github.com/sony/nnabla) (👨‍💻 76 · 🔀 340 · 📥 1K · 📋 95 - 36% open · ⏱️ 29.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/nnabla) (📥 2.3K / month · 📦 44 · ⏱️ 29.05.2024):
	```
	pip install nnabla
	```
</details>
...
- [GitHub](https://github.com/deepinv/deepinv) (👨‍💻 52 · 🔀 120 · 📥 22 · 📦 23 · 📋 350 - 34% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/deepinv/deepinv
	```
- [PyPi](https://pypi.org/project/deepinv) (📥 2.9K / month · ⏱️ 08.10.2025):
	```
	pip install deepinv
	```
</details>
...
- [GitHub](https://github.com/towhee-io/towhee) (👨‍💻 38 · 🔀 260 · 📥 2.7K · 📋 670 - 0% open · ⏱️ 18.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/towhee) (📥 1.4K / month · ⏱️ 04.12.2023):
	```
	pip install towhee
	```
</details>
...
- [GitHub](https://github.com/nubank/fklearn) (👨‍💻 56 · 🔀 170 · 📦 16 · 📋 64 - 60% open · ⏱️ 23.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fklearn) (📥 990 / month · ⏱️ 26.02.2025):
	```
	pip install fklearn
	```
</details>
...
- [GitHub](https://github.com/run-house/kubetorch) (👨‍💻 16 · 🔀 42 · 📥 79 · ⏱️ 23.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/runhouse) (📥 4.7K / month · 📦 1 · ⏱️ 10.03.2025):
	```
...
- [GitHub](https://github.com/neoml-lib/neoml) (👨‍💻 40 · 🔀 130 · 📦 2 · 📋 91 - 40% open · ⏱️ 15.07.2025):

	```
	git clone https://github.com/neoml-lib/neoml
	```
- [PyPi](https://pypi.org/project/neoml) (📥 340 / month · ⏱️ 26.12.2023):
	```
	pip install neoml
	```
</details>
...
- [GitHub](https://github.com/serengil/chefboost) (👨‍💻 7 · 🔀 100 · 📦 72 · ⏱️ 09.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/chefboost) (📥 860 / month · ⏱️ 30.10.2024):
	```
...
- <b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥈33 ·  ⭐ 37K) - AI Analytics and Knowledge Engine for RAG over large-scale,.. <code><a href="https://tldrlegal.com/search?q=ICU">❗️ICU</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/VowpalWabbit/vowpal_wabbit">Vowpal Wabbit</a></b> (🥉32 ·  ⭐ 8.6K · 💀) - Vowpal Wabbit is a machine learning system which pushes the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/Lasagne/Lasagne">Lasagne</a></b> (🥉29 ·  ⭐ 3.9K · 💀) - Lightweight library to build and train neural networks in Theano. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/matplotlib/matplotlib) (👨‍💻 1.9K · 🔀 8.1K · 📦 1.9M · 📋 11K - 14% open · ⏱️ 22.10.2025):
...
- [GitHub](https://github.com/plotly/plotly.py) (👨‍💻 300 · 🔀 2.7K · 📥 540 · 📦 460K · 📋 3.3K - 21% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/plotly/plotly.py
	```
- [PyPi](https://pypi.org/project/plotly) (📥 36M / month · 📦 9.7K · ⏱️ 02.10.2025):
	```
	pip install plotly
	```
- [Conda](https://anaconda.org/conda-forge/plotly) (📥 12M · ⏱️ 03.10.2025):
	...
	```
- [npm](https://www.npmjs.com/package/plotlywidget) (📥 2.7K / month · 📦 9 · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/plotly/dash) (👨‍💻 190 · 🔀 2.2K · 📥 120 · 📦 89K · 📋 2.1K - 27% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/dash) (📥 5.3M / month · 📦 1.9K · ⏱️ 22.10.2025):
	```
	pip install dash
	```
...
- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 160 · 🔀 680 · 📦 1K · 📋 1.8K - 35% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/voxel51/fiftyone
	```
- [PyPi](https://pypi.org/project/fiftyone) (📥 160K / month · 📦 36 · ⏱️ 20.10.2025):
	```
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 24 · 🔀 220 · 📦 95K · 📋 190 - 6% open · ⏱️ 12.10.2025):
...
- [PyPi](https://pypi.org/project/graphviz) (📥 26M / month · 📦 3.2K · ⏱️ 15.06.2025):
	...
	```
- [Conda](https://anaconda.org/anaconda/python-graphviz) (📥 58K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 190 · 🔀 590 · 📥 960 · 📦 5.2K · 📋 2K - 35% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/pyvista/pyvista
	```
- [PyPi](https://pypi.org/project/pyvista) (📥 880K / month · 📦 820 · ⏱️ 26.08.2025):
	```
	pip install pyvista
	```
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 150 · 🔀 410 · 📦 17K · 📋 3.4K - 31% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/holoviz/holoviews
	```
- [PyPi](https://pypi.org/project/holoviews) (📥 850K / month · 📦 470 · ⏱️ 29.09.2025):
	```
...
- [Conda](https://anaconda.org/conda-forge/holoviews) (📥 2.4M · ⏱️ 25.06.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@pyviz/jupyterlab_pyviz) (📥 370 / month · 📦 7 · ⏱️ 20.06.2025):
	```
...
- [GitHub](https://github.com/pyecharts/pyecharts) (👨‍💻 45 · 🔀 2.9K · 📥 75 · 📦 5.5K · 📋 1.9K - 0% open · ⏱️ 10.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyecharts) (📥 500K / month · 📦 280 · ⏱️ 10.10.2025):
	```
...
- [GitHub](https://github.com/pyqtgraph/pyqtgraph) (👨‍💻 300 · 🔀 1.1K · 📦 13K · 📋 1.4K - 31% open · ⏱️ 02.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyqtgraph) (📥 580K / month · 📦 1K · ⏱️ 29.04.2024):
	```
...
<details><summary><b><a href="https://github.com/vispy/vispy">VisPy</a></b> (🥈35 ·  ⭐ 3.5K) - High-performance interactive 2D/3D data visualization library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 210 · 🔀 620 · 📦 2.1K · 📋 1.5K - 25% open · ⏱️ 13.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/vispy) (📥 210K / month · 📦 200 · ⏱️ 19.05.2025):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 970K · ⏱️ 30.08.2025):
	...
	```
- [npm](https://www.npmjs.com/package/vispy) (📥 9 / month · 📦 3 · ⏱️ 15.03.2020):
	```
	npm install vispy
	```
</details>
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 140 · 🔀 390 · 📦 8.1K · 📋 1.3K - 23% open · ⏱️ 24.09.2025):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 790K / month · 📦 970 · ⏱️ 01.08.2025):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/JetBrains/lets-plot) (👨‍💻 21 · 🔀 54 · 📥 3.4K · 📦 190 · 📋 730 - 21% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/JetBrains/lets-plot
	```
- [PyPi](https://pypi.org/project/lets-plot) (📥 130K / month · 📦 16 · ⏱️ 12.09.2025):
	```
...
<details><summary><b><a href="https://github.com/lmcinnes/umap">UMAP</a></b> (🥈32 ·  ⭐ 8K) - Uniform Manifold Approximation and Projection. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lmcinnes/umap) (👨‍💻 140 · 🔀 850 · 📦 1 · 📋 860 - 59% open · ⏱️ 12.10.2025):
...
<details><summary><b><a href="https://github.com/mpld3/mpld3">mpld3</a></b> (🥈32 ·  ⭐ 2.4K) - An interactive data visualization tool which brings matplotlib graphics to.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mpld3/mpld3) (👨‍💻 54 · 🔀 360 · 📦 7.6K · 📋 370 - 59% open · ⏱️ 27.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/mpld3) (📥 450K / month · 📦 160 · ⏱️ 27.07.2025):
	```
	pip install mpld3
	```
- [Conda](https://anaconda.org/conda-forge/mpld3) (📥 280K · ⏱️ 28.07.2025):
	...
	```
- [npm](https://www.npmjs.com/package/mpld3) (📥 1.1K / month · 📦 11 · ⏱️ 27.07.2025):
	```
	npm install mpld3
	```
</details>
...
- [GitHub](https://github.com/holoviz/hvplot) (👨‍💻 52 · 🔀 110 · 📦 7.3K · 📋 940 - 41% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/holoviz/hvplot
	```
- [PyPi](https://pypi.org/project/hvplot) (📥 320K / month · 📦 270 · ⏱️ 29.08.2025):
	```
	pip install hvplot
	```
...
- [GitHub](https://github.com/ContextLab/hypertools) (👨‍💻 23 · 🔀 160 · 📥 73 · 📦 510 · 📋 200 - 34% open · ⏱️ 10.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/hypertools) (📥 1.4K / month · 📦 2 · ⏱️ 09.07.2025):
	```
...
- [GitHub](https://github.com/predict-idlab/plotly-resampler) (👨‍💻 14 · 🔀 74 · 📦 2K · 📋 190 - 32% open · ⏱️ 03.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/plotly-resampler) (📥 380K / month · 📦 38 · ⏱️ 29.08.2025):
	```
...
- [GitHub](https://github.com/pavlin-policar/openTSNE) (👨‍💻 13 · 🔀 170 · 📦 1.1K · 📋 140 - 6% open · ⏱️ 12.08.2025):

	```
	git clone https://github.com/pavlin-policar/openTSNE
	```
- [PyPi](https://pypi.org/project/opentsne) (📥 62K / month · 📦 47 · ⏱️ 13.08.2024):
	```
...
- [GitHub](https://github.com/spotify/chartify) (👨‍💻 27 · 🔀 340 · 📦 83 · 📋 86 - 62% open · ⏱️ 16.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/chartify) (📥 1.6K / month · 📦 9 · ⏱️ 16.10.2024):
	```
...
- [GitHub](https://github.com/ing-bank/popmon) (👨‍💻 19 · 🔀 36 · 📥 280 · 📦 22 · 📋 57 - 28% open · ⏱️ 04.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/popmon) (📥 2.9K / month · 📦 4 · ⏱️ 04.09.2025):
	```
	pip install popmon
	```
</details>
...
<details><summary><b><a href="https://github.com/vega/vegafusion">vegafusion</a></b> (🥉21 ·  ⭐ 380) - Serverside scaling for Vega and Altair visualizations. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/vega/vegafusion) (👨‍💻 6 · 🔀 26 · 📥 6.5K · 📋 150 - 36% open · ⏱️ 29.09.2025):

	```
	git clone https://github.com/vegafusion/vegafusion
	```
- [PyPi](https://pypi.org/project/vegafusion-jupyter) (📥 900 / month · 📦 2 · ⏱️ 09.05.2024):
	```
...
- <b><a href="https://github.com/t-makaro/animatplot">animatplot</a></b> (🥉19 ·  ⭐ 410 · 💀) - A python package for animating plots build on matplotlib. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/huggingface/transformers) (👨‍💻 3.6K · 🔀 31K · 📦 400K · 📋 19K - 10% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/huggingface/transformers
	```
- [PyPi](https://pypi.org/project/transformers) (📥 91M / month · 📦 11K · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/nltk/nltk) (👨‍💻 480 · 🔀 3K · 📦 410K · 📋 1.9K - 14% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/nltk) (📥 40M / month · 📦 6.3K · ⏱️ 01.10.2025):
	```
	pip install nltk
	```
...
<details><summary><b><a href="https://github.com/BerriAI/litellm">litellm</a></b> (🥇46 ·  ⭐ 30K) - Python SDK, Proxy Server (LLM Gateway) to call 100+.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code>o</code> <code>t</code> <code>h</code> <code>e</code> <code>r</code> <code>s</code></summary>

- [GitHub](https://github.com/BerriAI/litellm) (👨‍💻 940 · 🔀 4.4K · 📥 820 · 📦 17K · 📋 7.7K - 17% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/BerriAI/litellm
	```
- [PyPi](https://pypi.org/project/litellm) (📥 32M / month · 📦 1.9K · ⏱️ 22.10.2025):
	```
	pip install litellm
	```
</details>
...
- [GitHub](https://github.com/explosion/spaCy) (👨‍💻 770 · 🔀 4.5K · 📥 4.8K · 📦 140K · 📋 5.7K - 3% open · ⏱️ 28.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/spacy) (📥 16M / month · 📦 3.2K · ⏱️ 23.05.2025):
	```
	pip install spacy
	```
...
- [GitHub](https://github.com/piskvorky/gensim) (👨‍💻 460 · 🔀 4.4K · 📥 6.4K · 📦 78K · 📋 1.9K - 21% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/gensim) (📥 4.7M / month · 📦 1.6K · ⏱️ 18.10.2025):
	```
	pip install gensim
	```
...
- [GitHub](https://github.com/google/sentencepiece) (👨‍💻 100 · 🔀 1.3K · 📥 100K · 📦 120K · 📋 800 - 3% open · ⏱️ 04.10.2025):

	```
	git clone https://github.com/google/sentencepiece
	```
- [PyPi](https://pypi.org/project/sentencepiece) (📥 30M / month · 📦 2.4K · ⏱️ 12.08.2025):
	```
...
- [GitHub](https://github.com/huggingface/tokenizers) (👨‍💻 130 · 🔀 970 · 📥 86 · 📦 180K · 📋 1.1K - 9% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/tokenizers) (📥 78M / month · 📦 1.7K · ⏱️ 19.09.2025):
	```
...
- [GitHub](https://github.com/NVIDIA-NeMo/NeMo) (👨‍💻 460 · 🔀 3.1K · 📥 520K · 📦 21 · 📋 2.8K - 4% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/NVIDIA/NeMo
	```
- [PyPi](https://pypi.org/project/nemo-toolkit) (📥 850K / month · 📦 18 · ⏱️ 22.10.2025):
	```
	pip install nemo-toolkit
	```
</details>
<details><summary><b><a href="https://github.com/deepset-ai/haystack">haystack</a></b> (🥇37 ·  ⭐ 23K · 📉) - AI orchestration framework to build customizable, production-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 310 · 🔀 2.4K · 📦 1.3K · 📋 4.1K - 2% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/deepset-ai/haystack
	```
- [PyPi](https://pypi.org/project/haystack) (📥 7.8K / month · 📦 5 · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/comet-ml/opik) (👨‍💻 78 · 🔀 1.1K · 📦 17 · 📋 520 - 29% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/comet-ml/opik
	```
- [PyPi](https://pypi.org/project/opik) (📥 750K / month · 📦 34 · ⏱️ 22.10.2025):
	```
	pip install opik
	```
</details>
...
- [GitHub](https://github.com/flairNLP/flair) (👨‍💻 280 · 🔀 2.1K · 📦 4.1K · 📋 2.4K - 1% open · ⏱️ 12.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/flair) (📥 190K / month · 📦 160 · ⏱️ 05.02.2025):
	```
	pip install flair
	```
...
<details><summary><b><a href="https://github.com/sloria/TextBlob">TextBlob</a></b> (🥇37 ·  ⭐ 9.4K) - Simple, Pythonic, text processing--Sentiment analysis, part-of-speech.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 37 · 🔀 1.2K · 📥 140 · 📦 60K · 📋 280 - 26% open · ⏱️ 18.10.2025):
...
- [GitHub](https://github.com/facebookresearch/fairseq) (👨‍💻 430 · 🔀 6.6K · 📥 440 · 📦 4.4K · 📋 4.4K - 30% open · ⏱️ 30.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/fairseq) (📥 85K / month · 📦 120 · ⏱️ 27.06.2022):
	```
	pip install fairseq
	```
...
<details><summary><b><a href="https://github.com/gunthercox/ChatterBot">ChatterBot</a></b> (🥈36 ·  ⭐ 14K) - ChatterBot is a machine learning, conversational dialog engine for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/gunthercox/ChatterBot) (👨‍💻 110 · 🔀 4.5K · 📦 6.5K · 📋 1.7K - 6% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/gunthercox/ChatterBot
	```
- [PyPi](https://pypi.org/project/chatterbot) (📥 21K / month · 📦 19 · ⏱️ 16.10.2025):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 72 · 🔀 920 · 📦 4.1K · 📋 950 - 10% open · ⏱️ 05.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/stanza) (📥 810K / month · 📦 240 · ⏱️ 05.10.2025):
	```
	pip install stanza
	```
...
- [GitHub](https://github.com/RasaHQ/rasa) (👨‍💻 600 · 🔀 4.9K · 📋 6.8K - 2% open · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/rasa) (📥 100K / month · 📦 60 · ⏱️ 14.01.2025):
	```
	pip install rasa
	```
</details>
...
- [GitHub](https://github.com/tensorflow/text) (👨‍💻 190 · 🔀 360 · 📦 10K · 📋 370 - 53% open · ⏱️ 18.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-text) (📥 6.7M / month · 📦 230 · ⏱️ 04.04.2025):
	```
	pip install tensorflow-text
	```
</details>
<details><summary><b><a href="https://github.com/snowballstem/snowball">snowballstemmer</a></b> (🥈33 ·  ⭐ 810) - Snowball compiler and stemming algorithms. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/snowballstem/snowball) (👨‍💻 40 · 🔀 190 · 📦 11 · 📋 120 - 17% open · ⏱️ 21.10.2025):
...
- [GitHub](https://github.com/jamesturk/jellyfish) (👨‍💻 37 · 🔀 160 · 📦 15K · ⏱️ 11.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/jellyfish) (📥 8.4M / month · 📦 320 · ⏱️ 11.10.2025):
	```
...
- [GitHub](https://github.com/cltk/cltk) (👨‍💻 120 · 🔀 340 · 📥 160 · 📦 300 · 📋 580 - 0% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/cltk) (📥 17K / month · 📦 17 · ⏱️ 21.10.2025):
	```
	pip install cltk
	```
</details>
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 22 · 🔀 120 · 📥 99 · 📦 33K · 📋 150 - 7% open · ⏱️ 30.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/ftfy) (📥 10M / month · 📦 570 · ⏱️ 26.10.2024):
	```
	pip install ftfy
	```
...
- [GitHub](https://github.com/allenai/scispacy) (👨‍💻 38 · 🔀 240 · 📦 1.3K · 📋 330 - 11% open · ⏱️ 01.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/scispacy) (📥 46K / month · 📦 50 · ⏱️ 01.10.2025):
	```
...
- [GitHub](https://github.com/dwyl/english-words) (👨‍💻 34 · 🔀 2K · 📦 2 · 📋 170 - 75% open · ⏱️ 06.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/english-words) (📥 74K / month · 📦 15 · ⏱️ 14.08.2025):
	```
...
- [GitHub](https://github.com/argilla-io/argilla) (👨‍💻 110 · 🔀 460 · 📦 3.1K · 📋 2.2K - 0% open · ⏱️ 05.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/rubrix) (📥 1.6K / month · ⏱️ 24.10.2022):
	```
	pip install rubrix
	```
...
- [GitHub](https://github.com/dedupeio/dedupe) (👨‍💻 72 · 🔀 560 · 📦 370 · 📋 820 - 9% open · ⏱️ 29.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/dedupe) (📥 57K / month · 📦 19 · ⏱️ 15.08.2024):
	```
	pip install dedupe
	```
...
- [GitHub](https://github.com/google-research/text-to-text-transfer-transformer) (👨‍💻 61 · 🔀 780 · 📋 450 - 23% open · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/t5) (📥 110K / month · 📦 2 · ⏱️ 18.10.2021):
	```
	pip install t5
	```
</details>
...
- [GitHub](https://github.com/zjunlp/DeepKE) (👨‍💻 34 · 🔀 720 · 📦 25 · 📋 620 - 0% open · ⏱️ 19.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/deepke) (📥 930 / month · ⏱️ 21.09.2023):
	```
	pip install deepke
	```
</details>
...
- [GitHub](https://github.com/explosion/sense2vec) (👨‍💻 20 · 🔀 240 · 📥 73K · 📦 470 · 📋 120 - 20% open · ⏱️ 23.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/sense2vec) (📥 3.8K / month · 📦 13 · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/IndicoDataSolutions/finetune) (👨‍💻 24 · 🔀 79 · 📦 16 · 📋 190 - 39% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/finetune) (📥 2.9K / month · 📦 2 · ⏱️ 29.09.2023):
	```
...
- [GitHub](https://github.com/EricFillion/happy-transformer) (👨‍💻 14 · 🔀 69 · 📦 330 · 📋 130 - 16% open · ⏱️ 22.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/happytransformer) (📥 2.6K / month · 📦 5 · ⏱️ 05.08.2023):
	```
...
- [GitHub](https://github.com/awslabs/sockeye) (👨‍💻 60 · 🔀 320 · 📥 21 · 📋 310 - 3% open · ⏱️ 24.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/sockeye) (📥 780 / month · ⏱️ 03.03.2023):
	```
	pip install sockeye
	```
</details>
...
- [GitHub](https://github.com/unum-cloud/UForm) (👨‍💻 21 · 🔀 76 · 📥 700 · 📦 36 · 📋 39 - 38% open · ⏱️ 03.09.2025):

	```
	git clone https://github.com/unum-cloud/uform
	```
- [PyPi](https://pypi.org/project/uform) (📥 510 / month · 📦 2 · ⏱️ 03.09.2025):
	```
	pip install uform
	```
</details>
...
- [GitHub](https://github.com/webis-de/small-text) (👨‍💻 9 · 🔀 76 · 📦 34 · 📋 74 - 28% open · ⏱️ 24.08.2025):

	```
	git clone https://github.com/webis-de/small-text
	```
- [PyPi](https://pypi.org/project/small-text) (📥 580 / month · ⏱️ 17.08.2025):
	```
...
- [GitHub](https://github.com/dsfsi/textaugment) (👨‍💻 10 · 🔀 60 · 📥 140 · 📦 180 · 📋 29 - 37% open · ⏱️ 09.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/textaugment) (📥 4.4K / month · 📦 4 · ⏱️ 16.11.2023):
	```
...
- <b><a href="https://github.com/cjhutto/vaderSentiment">vaderSentiment</a></b> (🥈28 ·  ⭐ 4.8K · 💀) - VADER Sentiment Analysis. VADER (Valence Aware Dictionary.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/thunlp/OpenPrompt">OpenPrompt</a></b> (🥉25 ·  ⭐ 4.7K · 💀) - An Open-Source Framework for Prompt-Learning. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/anhaidgroup/deepmatcher">DeepMatcher</a></b> (🥉19 ·  ⭐ 5.2K · 💀) - Python package for performing Entity and Text Matching using.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 490 · 🔀 2.3K · 📦 2.4M · 📋 3.4K - 3% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 210M / month · 📦 19K · ⏱️ 15.10.2025):
	```
	pip install Pillow
	```
...
- [GitHub](https://github.com/huggingface/pytorch-image-models) (👨‍💻 180 · 🔀 5K · 📥 8.4M · 📦 62K · 📋 1K - 4% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/rwightman/pytorch-image-models
	```
- [PyPi](https://pypi.org/project/timm) (📥 11M / month · 📦 1.4K · ⏱️ 21.09.2025):
	```
	pip install timm
	```
...
- [GitHub](https://github.com/pytorch/vision) (👨‍💻 660 · 🔀 7.2K · 📥 41K · 📦 21 · 📋 3.8K - 30% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/pytorch/vision
	```
- [PyPi](https://pypi.org/project/torchvision) (📥 25M / month · 📦 8.4K · ⏱️ 15.10.2025):
	```
...
- [GitHub](https://github.com/serengil/deepface) (👨‍💻 96 · 🔀 2.8K · 📦 8.4K · 📋 1.2K - 0% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/deepface) (📥 260K / month · 📦 78 · ⏱️ 05.08.2025):
	```
...
- [GitHub](https://github.com/kornia/kornia) (👨‍💻 300 · 🔀 1K · 📥 2.2K · 📦 17K · 📋 990 - 30% open · ⏱️ 14.10.2025):

	```
	git clone https://github.com/kornia/kornia
	```
- [PyPi](https://pypi.org/project/kornia) (📥 2.9M / month · 📦 340 · ⏱️ 08.05.2025):
	```
	pip install kornia
	```
...
- [GitHub](https://github.com/imageio/imageio) (👨‍💻 130 · 🔀 330 · 📥 1.9K · 📦 180K · 📋 620 - 16% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/imageio) (📥 35M / month · 📦 2.6K · ⏱️ 20.01.2025):
	```
	pip install imageio
	```
...
- [GitHub](https://github.com/deepinsight/insightface) (👨‍💻 67 · 🔀 5.7K · 📥 10M · 📦 4.8K · 📋 2.6K - 46% open · ⏱️ 27.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/insightface) (📥 380K / month · 📦 30 · ⏱️ 17.12.2022):
	```
...
- [GitHub](https://github.com/albumentations-team/albumentations) (👨‍💻 170 · 🔀 1.7K · 📋 1.5K - 14% open · ⏱️ 25.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/albumentations) (📥 4.7M / month · 📦 730 · ⏱️ 27.05.2025):
	```
...
- [GitHub](https://github.com/opencv/opencv-python) (👨‍💻 56 · 🔀 950 · 📦 610K · 📋 890 - 19% open · ⏱️ 30.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/opencv-python) (📥 28M / month · 📦 15K · ⏱️ 07.07.2025):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 110 · 🔀 200 · 📥 52K · 📦 21K · 📋 440 - 5% open · ⏱️ 06.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/wand) (📥 2.1M / month · 📦 260 · ⏱️ 03.11.2023):
	```
	pip install wand
	```
...
- [GitHub](https://github.com/facebookresearch/detectron2) (👨‍💻 280 · 🔀 7.5K · 📦 2.6K · 📋 3.6K - 14% open · ⏱️ 27.08.2025):
...
- [GitHub](https://github.com/JohannesBuchner/imagehash) (👨‍💻 29 · 🔀 340 · 📦 18K · 📋 150 - 15% open · ⏱️ 17.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/ImageHash) (📥 5.4M / month · 📦 270 · ⏱️ 01.02.2025):
	```
...
- [GitHub](https://github.com/lucidrains/vit-pytorch) (👨‍💻 24 · 🔀 3.4K · 📦 21 · 📋 280 - 49% open · ⏱️ 13.10.2025):

	```
	git clone https://github.com/lucidrains/vit-pytorch
	```
- [PyPi](https://pypi.org/project/vit-pytorch) (📥 31K / month · 📦 28 · ⏱️ 13.10.2025):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleSeg) (👨‍💻 130 · 🔀 1.7K · 📦 1.5K · 📋 2.2K - 0% open · ⏱️ 10.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/paddleseg) (📥 4.7K / month · 📦 7 · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/obss/sahi) (👨‍💻 69 · 🔀 700 · 📥 43K · 📦 1.9K · ⏱️ 19.10.2025):
...
- [GitHub](https://github.com/lightly-ai/lightly) (👨‍💻 72 · 🔀 310 · 📦 510 · 📋 610 - 12% open · ⏱️ 25.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/lightly) (📥 200K / month · 📦 20 · ⏱️ 22.07.2025):
	```
	pip install lightly
	```
</details>
...
- [GitHub](https://github.com/mindee/doctr) (👨‍💻 68 · 🔀 580 · 📥 6.4M · 📋 440 - 6% open · ⏱️ 07.09.2025):

	```
	git clone https://github.com/mindee/doctr
	```
- [PyPi](https://pypi.org/project/python-doctr) (📥 1.8M / month · 📦 18 · ⏱️ 09.07.2025):
	```
...
- [GitHub](https://github.com/PaddlePaddle/PaddleDetection) (👨‍💻 190 · 🔀 3K · 📋 5.7K - 17% open · ⏱️ 10.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/paddledet) (📥 3.2K / month · 📦 2 · ⏱️ 19.09.2022):
	```
	pip install paddledet
	```
</details>
<details><summary><b><a href="https://github.com/luispedro/mahotas">mahotas</a></b> (🥉28 ·  ⭐ 880) - Computer Vision in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/luispedro/mahotas) (👨‍💻 35 · 🔀 150 · 📦 1.6K · 📋 92 - 21% open · ⏱️ 05.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/mahotas) (📥 50K / month · 📦 63 · ⏱️ 17.07.2024):
	```
	pip install mahotas
	```
...
- [GitHub](https://github.com/idealo/imagededup) (👨‍💻 19 · 🔀 460 · 📥 29 · 📦 200 · 📋 140 - 25% open · ⏱️ 15.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/imagededup) (📥 67K / month · 📦 29 · ⏱️ 15.08.2025):
	```
...
- [GitHub](https://github.com/ipazc/mtcnn) (👨‍💻 15 · 🔀 530 · 📥 74 · 📦 9.2K · 📋 130 - 37% open · ⏱️ 08.10.2024):
...
- [GitHub](https://github.com/CellProfiler/CellProfiler) (👨‍💻 150 · 🔀 410 · 📥 23K · 📦 28 · 📋 3.4K - 10% open · ⏱️ 24.09.2025):

	```
	git clone https://github.com/CellProfiler/CellProfiler
	```
- [PyPi](https://pypi.org/project/cellprofiler) (📥 1.9K / month · 📦 2 · ⏱️ 16.09.2024):
	```
...
- [GitHub](https://github.com/tryolabs/norfair) (👨‍💻 32 · 🔀 260 · 📥 360 · 📦 340 · 📋 180 - 16% open · ⏱️ 30.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/norfair) (📥 43K / month · 📦 9 · ⏱️ 30.04.2025):
	```
	pip install norfair
	```
</details>
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 17 · 🔀 52 · 📦 1.2K · 📋 660 - 29% open · ⏱️ 04.09.2025):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 180K / month · 📦 94 · ⏱️ 28.04.2025):
	```
	pip install pyvips
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/pytorchvideo">pytorchvideo</a></b> (🥉25 ·  ⭐ 3.5K · 💤) - A deep learning library for video understanding.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/facebookresearch/pytorchvideo) (👨‍💻 58 · 🔀 420 · 📋 210 - 50% open · ⏱️ 25.01.2025):
...
- [GitHub](https://github.com/tensorflow/graphics) (👨‍💻 39 · 🔀 370 · 📋 240 - 60% open · ⏱️ 03.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-graphics) (📥 57K / month · 📦 11 · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/mmf) (👨‍💻 120 · 🔀 920 · 📦 23 · 📋 690 - 21% open · ⏱️ 24.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/mmf) (📥 330 / month · 📦 1 · ⏱️ 12.06.2020):
	```
	pip install mmf
	```
</details>
<details><summary><b><a href="https://github.com/google-research/kubric">kubric</a></b> (🥉23 ·  ⭐ 2.6K) - A data generation pipeline for creating semi-realistic synthetic.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/google-research/kubric) (👨‍💻 32 · 🔀 250 · 📦 7 · 📋 200 - 35% open · ⏱️ 06.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/kubric-nightly) (📥 8.8K / month · ⏱️ 27.12.2023):
	```
...
- [GitHub](https://github.com/airctic/icevision) (👨‍💻 41 · 🔀 130 · 📋 570 - 10% open · ⏱️ 31.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/icevision) (📥 3.4K / month · 📦 6 · ⏱️ 10.02.2022):
	```
...
- [GitHub](https://github.com/facebookresearch/SlowFast) (👨‍💻 34 · 🔀 1.2K · 📦 23 · 📋 720 - 59% open · ⏱️ 26.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/pyslowfast) (📥 42 / month · ⏱️ 15.01.2020):
	```
...
<details><summary><b><a href="https://github.com/jasmcaus/caer">Caer</a></b> (🥉21 ·  ⭐ 810) - A lightweight Computer Vision library. Scale your models, not boilerplate. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jasmcaus/caer) (👨‍💻 8 · 🔀 110 · 📥 48 · ⏱️ 11.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/caer) (📥 4.8K / month · 📦 3 · ⏱️ 11.08.2025):
	```
	pip install caer
	```
</details>
...
- <b><a href="https://github.com/scikit-image/scikit-image">scikit-image</a></b> (🥇40 ·  ⭐ 6.4K) - Image processing in Python. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/facebookresearch/pytorch3d">PyTorch3D</a></b> (🥈31 ·  ⭐ 9.6K) - PyTorch3D is FAIRs library of reusable components for.. <code>❗Unlicensed</code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/Layout-Parser/layout-parser">layout-parser</a></b> (🥉24 ·  ⭐ 5.5K · 💀) - A Unified Toolkit for Deep Learning Based Document Image.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/networkx/networkx) (👨‍💻 790 · 🔀 3.4K · 📥 110 · 📦 430K · 📋 3.5K - 11% open · ⏱️ 21.10.2025):
...
- [GitHub](https://github.com/pyg-team/pytorch_geometric) (👨‍💻 560 · 🔀 3.9K · 📦 11K · 📋 4K - 30% open · ⏱️ 14.10.2025):

	```
	git clone https://github.com/pyg-team/pytorch_geometric
	```
- [PyPi](https://pypi.org/project/torch-geometric) (📥 920K / month · 📦 730 · ⏱️ 15.10.2025):
	```
...
- [GitHub](https://github.com/dmlc/dgl) (👨‍💻 300 · 🔀 3K · 📦 4.1K · 📋 3K - 20% open · ⏱️ 31.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/dgl) (📥 180K / month · 📦 150 · ⏱️ 13.05.2024):
	```
	pip install dgl
	```
</details>
<details><summary><b><a href="https://github.com/graphistry/pygraphistry">pygraphistry</a></b> (🥈29 ·  ⭐ 2.3K) - PyGraphistry is a Python library to quickly load, shape,.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://git.io/JLy1E" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/graphistry/pygraphistry) (👨‍💻 48 · 🔀 220 · 📋 420 - 51% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/graphistry/pygraphistry
	```
- [PyPi](https://pypi.org/project/graphistry) (📥 9.7K / month · 📦 9 · ⏱️ 21.10.2025):
	```
...
- [GitHub](https://github.com/snap-stanford/ogb) (👨‍💻 32 · 🔀 400 · 📦 2.6K · 📋 310 - 11% open · ⏱️ 06.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/ogb) (📥 110K / month · 📦 73 · ⏱️ 07.04.2023):
	```
	pip install ogb
	```
...
- [GitHub](https://github.com/pykeen/pykeen) (👨‍💻 43 · 🔀 210 · 📥 240 · 📦 350 · 📋 590 - 20% open · ⏱️ 18.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/pykeen) (📥 34K / month · 📦 28 · ⏱️ 24.04.2025):
	```
	pip install pykeen
	```
</details>
...
- [GitHub](https://github.com/benedekrozemberczki/pytorch_geometric_temporal) (👨‍💻 39 · 🔀 400 · 📋 210 - 18% open · ⏱️ 18.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/torch-geometric-temporal) (📥 7.6K / month · 📦 12 · ⏱️ 16.07.2025):
	```
...
- [GitHub](https://github.com/rusty1s/pytorch_cluster) (👨‍💻 40 · 🔀 150 · 📋 190 - 16% open · ⏱️ 12.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/torch-cluster) (📥 40K / month · 📦 62 · ⏱️ 12.10.2023):
	```
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 520 · 🔀 2.3K · 📥 84 · 📦 480 · 📋 2.5K - 3% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/espnet/espnet
	```
- [PyPi](https://pypi.org/project/espnet) (📥 26K / month · 📦 19 · ⏱️ 13.09.2025):
	```
	pip install espnet
	```
</details>
...
- [GitHub](https://github.com/speechbrain/speechbrain) (👨‍💻 260 · 🔀 1.5K · 📦 3.9K · 📋 1.2K - 12% open · ⏱️ 09.10.2025):

	```
	git clone https://github.com/speechbrain/speechbrain
	```
- [PyPi](https://pypi.org/project/speechbrain) (📥 1.2M / month · 📦 79 · ⏱️ 07.04.2025):
	```
...
- [GitHub](https://github.com/pytorch/audio) (👨‍💻 240 · 🔀 730 · 📋 1.1K - 31% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/pytorch/audio
	```
- [PyPi](https://pypi.org/project/torchaudio) (📥 14M / month · 📦 2.4K · ⏱️ 15.10.2025):
	```
...
- [GitHub](https://github.com/Uberi/speech_recognition) (👨‍💻 55 · 🔀 2.4K · 📦 21 · 📋 670 - 48% open · ⏱️ 14.09.2025):

	```
	git clone https://github.com/Uberi/speech_recognition
	```
- [PyPi](https://pypi.org/project/SpeechRecognition) (📥 2.1M / month · 📦 730 · ⏱️ 12.05.2025):
	```
...
- [GitHub](https://github.com/idiap/coqui-ai-TTS) (👨‍💻 200 · 🔀 240 · 📥 3.8K · 📦 760 · 📋 160 - 14% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/coqui-tts) (📥 90K / month · 📦 34 · ⏱️ 25.09.2025):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.7K · 📦 600 · 📋 1K - 41% open · ⏱️ 08.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 5.7K / month · 📦 5 · ⏱️ 01.08.2022):
	```
	pip install magenta
	```
</details>
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈31 ·  ⭐ 520) - cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 26 · 🔀 110 · 📦 35K · 📋 99 - 42% open · ⏱️ 12.10.2025):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 4.7M / month · 📦 180 · ⏱️ 12.10.2025):
	```
...
- [GitHub](https://github.com/Picovoice/porcupine) (👨‍💻 43 · 🔀 550 · 📦 51 · 📋 600 - 0% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pvporcupine) (📥 27K / month · 📦 38 · ⏱️ 05.02.2025):
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 28 · 🔀 1.2K · 📦 670 · 📋 320 - 62% open · ⏱️ 04.08.2025):
...
- [GitHub](https://github.com/tinytag/tinytag) (👨‍💻 27 · 🔀 100 · 📦 1.3K · 📋 120 - 4% open · ⏱️ 13.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 110K / month · 📦 130 · ⏱️ 13.08.2025):
	```
	pip install tinytag
	```
</details>
...
- [GitHub](https://github.com/bastibe/python-soundfile) (👨‍💻 38 · 🔀 120 · 📥 21K · 📋 260 - 46% open · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/soundfile) (📥 9.2M / month · 📦 1.1K · ⏱️ 25.01.2025):
	```
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉23 ·  ⭐ 930) - kapre: Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 150 · 📥 33 · 📦 2.5K · 📋 99 - 17% open · ⏱️ 13.10.2025):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 5.6K / month · 📦 9 · ⏱️ 21.01.2022):
	```
	pip install kapre
	```
</details>
<details><summary><b><a href="https://github.com/mozilla/DeepSpeech">DeepSpeech</a></b> (🥉21 ·  ⭐ 27K) - DeepSpeech is an open source embedded (offline, on-device).. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/mozilla/DeepSpeech) (👨‍💻 140 · 🔀 4.1K):

	```
	git clone https://github.com/mozilla/DeepSpeech
	```
- [PyPi](https://pypi.org/project/deepspeech) (📥 7K / month · 📦 24 · ⏱️ 19.12.2020):
	```
...
- [GitHub](https://github.com/adefossez/julius) (👨‍💻 3 · 🔀 26 · 📋 12 - 16% open · ⏱️ 17.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/julius) (📥 850K / month · 📦 44 · ⏱️ 20.09.2022):
	```
	pip install julius
	```
</details>
...
- <b><a href="https://github.com/MTG/essentia">Essentia</a></b> (🥉27 ·  ⭐ 3.2K) - C++ library for audio and music analysis, description and.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- [GitHub](https://github.com/visgl/deck.gl) (👨‍💻 300 · 🔀 2.2K · 📦 9.2K · 📋 3.3K - 13% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/visgl/deck.gl
	```
- [PyPi](https://pypi.org/project/pydeck) (📥 15M / month · 📦 160 · ⏱️ 21.03.2025):
	```
	pip install pydeck
	```
- [Conda](https://anaconda.org/conda-forge/pydeck) (📥 840K · ⏱️ 22.04.2025):
	...
	```
- [npm](https://www.npmjs.com/package/deck.gl) (📥 700K / month · 📦 360 · ⏱️ 16.10.2025):
	```
	npm install deck.gl
	```
</details>
...
- [GitHub](https://github.com/python-visualization/folium) (👨‍💻 180 · 🔀 2.2K · 📦 64K · 📋 1.2K - 6% open · ⏱️ 06.10.2025):

	```
	git clone https://github.com/python-visualization/folium
	```
- [PyPi](https://pypi.org/project/folium) (📥 2.7M / month · 📦 1K · ⏱️ 16.06.2025):
	```
	pip install folium
	```
...
- [GitHub](https://github.com/shapely/shapely) (👨‍💻 170 · 🔀 600 · 📥 4K · 📦 110K · 📋 1.3K - 18% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/shapely/shapely
	```
- [PyPi](https://pypi.org/project/shapely) (📥 61M / month · 📦 4.7K · ⏱️ 24.09.2025):
	```
	pip install shapely
	```
...
- [GitHub](https://github.com/geopandas/geopandas) (👨‍💻 250 · 🔀 980 · 📥 3.1K · 📦 60K · 📋 1.8K - 24% open · ⏱️ 22.10.2025):
...
- [GitHub](https://github.com/rasterio/rasterio) (👨‍💻 170 · 🔀 540 · 📥 1K · 📦 19K · 📋 1.9K - 8% open · ⏱️ 26.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/rasterio) (📥 2.7M / month · 📦 1.5K · ⏱️ 02.12.2024):
	```
...
- [GitHub](https://github.com/Esri/arcgis-python-api) (👨‍💻 99 · 🔀 1.1K · 📥 16K · 📦 1K · 📋 920 - 8% open · ⏱️ 13.10.2025):

	```
	git clone https://github.com/Esri/arcgis-python-api
	```
- [PyPi](https://pypi.org/project/arcgis) (📥 150K / month · 📦 42 · ⏱️ 12.08.2025):
	```
	pip install arcgis
	```
...
- [GitHub](https://github.com/Toblerity/Fiona) (👨‍💻 78 · 🔀 210 · 📦 27K · 📋 820 - 5% open · ⏱️ 20.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/fiona) (📥 5.7M / month · 📦 380 · ⏱️ 16.09.2024):
	```
	pip install fiona
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 58 · 🔀 120 · 📦 21K · 📋 100 - 26% open · ⏱️ 21.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/geojson) (📥 3.5M / month · 📦 720 · ⏱️ 21.12.2024):
	```
	pip install geojson
	```
...
- [GitHub](https://github.com/pysal/pysal) (👨‍💻 79 · 🔀 310 · 📦 1.8K · 📋 660 - 3% open · ⏱️ 08.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/pysal) (📥 46K / month · 📦 65 · ⏱️ 31.07.2025):
	```
	pip install pysal
	```
...
- [GitHub](https://github.com/holoviz/geoviews) (👨‍💻 34 · 🔀 79 · 📦 5 · 📋 360 - 31% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/holoviz/geoviews
	```
- [PyPi](https://pypi.org/project/geoviews) (📥 72K / month · 📦 76 · ⏱️ 14.08.2025):
	```
...
- [GitHub](https://github.com/earthlab/earthpy) (👨‍💻 44 · 🔀 160 · 📥 75 · 📦 440 · 📋 250 - 16% open · ⏱️ 31.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/earthpy) (📥 19K / month · 📦 17 · ⏱️ 01.10.2021):
	```
	pip install earthpy
	```
...
- [GitHub](https://github.com/ranaroussi/yfinance) (👨‍💻 140 · 🔀 2.8K · 📦 86K · 📋 1.7K - 9% open · ⏱️ 18.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/yfinance) (📥 5.7M / month · 📦 1.2K · ⏱️ 17.09.2025):
	```
...
- [GitHub](https://github.com/microsoft/qlib) (👨‍💻 140 · 🔀 5K · 📥 910 · 📦 21 · 📋 1K - 28% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyqlib) (📥 17K / month · 📦 3 · ⏱️ 15.08.2025):
	```
	pip install pyqlib
	```
</details>
...
- [GitHub](https://github.com/pmorissette/bt) (👨‍💻 35 · 🔀 450 · 📦 1.7K · 📋 350 - 23% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/bt) (📥 13K / month · 📦 15 · ⏱️ 12.04.2025):
	```
	pip install bt
	```
...
- [GitHub](https://github.com/pmorissette/ffn) (👨‍💻 36 · 🔀 330 · 📦 580 · 📋 140 - 17% open · ⏱️ 02.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/ffn) (📥 27K / month · 📦 22 · ⏱️ 11.02.2025):
	```
	pip install ffn
	```
...
<details><summary><b><a href="https://github.com/RomelTorres/alpha_vantage">Alpha Vantage</a></b> (🥉26 ·  ⭐ 4.6K) - A python wrapper for Alpha Vantage API for financial data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jealous/stockstats) (👨‍💻 10 · 🔀 310 · 📦 1.3K · 📋 130 - 10% open · ⏱️ 18.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/stockstats) (📥 49K / month · 📦 14 · ⏱️ 18.05.2025):
	```
...
- [GitHub](https://github.com/google/tf-quant-finance) (👨‍💻 48 · 🔀 630 · 📋 65 - 56% open · ⏱️ 21.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/tf-quant-finance) (📥 560 / month · 📦 3 · ⏱️ 19.08.2022):
	```
...
- <b><a href="https://github.com/bashtage/arch">arch</a></b> (🥇33 ·  ⭐ 1.4K) - ARCH models in Python. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/kernc/backtesting.py">Backtesting.py</a></b> (🥉26 ·  ⭐ 7.3K) - Backtest trading strategies in Python. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- <b><a href="https://github.com/fmilthaler/FinQuant">FinQuant</a></b> (🥉23 ·  ⭐ 1.6K · 💀) - A program for financial portfolio management, analysis and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/sktime/sktime) (👨‍💻 520 · 🔀 1.7K · 📥 110 · 📦 4.7K · 📋 3.1K - 39% open · ⏱️ 19.10.2025):
...
- [GitHub](https://github.com/facebook/prophet) (👨‍💻 190 · 🔀 4.6K · 📥 3.2K · 📦 21 · 📋 2.2K - 20% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/fbprophet) (📥 98K / month · 📦 91 · ⏱️ 05.09.2020):
	```
...
- [GitHub](https://github.com/Nixtla/statsforecast) (👨‍💻 56 · 🔀 330 · 📦 2K · 📋 380 - 32% open · ⏱️ 08.10.2025):

	```
	git clone https://github.com/Nixtla/statsforecast
	```
- [PyPi](https://pypi.org/project/statsforecast) (📥 1M / month · 📦 80 · ⏱️ 05.07.2025):
	```
...
- [GitHub](https://github.com/tslearn-team/tslearn) (👨‍💻 46 · 🔀 350 · 📦 1.9K · 📋 380 - 38% open · ⏱️ 22.10.2025):
...
- [GitHub](https://github.com/skforecast/skforecast) (👨‍💻 23 · 🔀 170 · 📦 490 · 📋 210 - 8% open · ⏱️ 22.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/skforecast) (📥 93K / month · 📦 18 · ⏱️ 22.09.2025):
	```
...
- [GitHub](https://github.com/unit8co/darts) (👨‍💻 140 · 🔀 970 · 📋 1.8K - 13% open · ⏱️ 10.10.2025):

	```
	git clone https://github.com/unit8co/darts
	```
- [PyPi](https://pypi.org/project/u8darts) (📥 84K / month · 📦 10 · ⏱️ 03.10.2025):
	```
	pip install u8darts
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 23 · 🔀 250 · 📦 13K · 📋 340 - 19% open · ⏱️ 07.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/pmdarima) (📥 6.9M / month · 📦 150 · ⏱️ 23.10.2023):
	```
...
- [GitHub](https://github.com/awslabs/gluonts) (👨‍💻 120 · 🔀 790 · 📋 970 - 34% open · ⏱️ 14.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/gluonts) (📥 980K / month · 📦 41 · ⏱️ 27.06.2025):
	```
	pip install gluonts
	```
...
- [GitHub](https://github.com/python-streamz/streamz) (👨‍💻 49 · 🔀 150 · 📦 570 · 📋 270 - 44% open · ⏱️ 22.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/streamz) (📥 30K / month · 📦 57 · ⏱️ 27.07.2022):
	```
	pip install streamz
	```
...
- [GitHub](https://github.com/johannfaouzi/pyts) (👨‍💻 15 · 🔀 180 · 📦 900 · 📋 88 - 59% open · ⏱️ 18.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyts) (📥 210K / month · 📦 45 · ⏱️ 18.06.2023):
	```
	pip install pyts
	```
...
- [GitHub](https://github.com/fraunhoferportugal/tsfel) (👨‍💻 21 · 🔀 150 · 📦 220 · 📋 86 - 4% open · ⏱️ 20.08.2025):

	```
	git clone https://github.com/fraunhoferportugal/tsfel
	```
- [PyPi](https://pypi.org/project/tsfel) (📥 12K / month · 📦 14 · ⏱️ 20.08.2025):
	```
	pip install tsfel
	```
</details>
...
- [GitHub](https://github.com/linkedin/greykite) (👨‍💻 10 · 🔀 110 · 📥 39 · 📦 47 · 📋 110 - 11% open · ⏱️ 20.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/greykite) (📥 10K / month · ⏱️ 20.02.2025):
	```
...
- [GitHub](https://github.com/nilearn/nilearn) (👨‍💻 260 · 🔀 610 · 📥 410 · 📦 4.4K · 📋 2.4K - 12% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/nilearn/nilearn
	```
- [PyPi](https://pypi.org/project/nilearn) (📥 200K / month · 📦 350 · ⏱️ 03.09.2025):
	```
	pip install nilearn
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAI) (👨‍💻 240 · 🔀 1.3K · 📦 4.5K · 📋 3.3K - 14% open · ⏱️ 10.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/monai) (📥 350K / month · 📦 200 · ⏱️ 22.09.2025):
	```
	pip install monai
	```
...
- [GitHub](https://github.com/mne-tools/mne-python) (👨‍💻 400 · 🔀 1.4K · 📋 5.1K - 11% open · ⏱️ 22.10.2025):
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 100 · 🔀 260 · 📦 170 · 📋 2.6K - 11% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/hail-is/hail
	```
- [PyPi](https://pypi.org/project/hail) (📥 120K / month · 📦 44 · ⏱️ 09.09.2025):
	```
	pip install hail
	```
</details>
...
- [GitHub](https://github.com/nipy/nibabel) (👨‍💻 110 · 🔀 260 · 📦 30K · 📋 550 - 23% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/nibabel) (📥 940K / month · 📦 1.2K · ⏱️ 23.10.2024):
	```
	pip install nibabel
	```
...
- [GitHub](https://github.com/nipy/nipype) (👨‍💻 260 · 🔀 530 · 📦 7.2K · 📋 1.4K - 30% open · ⏱️ 28.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/nipype) (📥 370K / month · 📦 150 · ⏱️ 19.03.2025):
	```
	pip install nipype
	```
...
- [GitHub](https://github.com/CamDavidsonPilon/lifelines) (👨‍💻 120 · 🔀 560 · 📦 4.2K · 📋 980 - 27% open · ⏱️ 29.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/lifelines) (📥 1.6M / month · 📦 160 · ⏱️ 29.10.2024):
	```
...
- [GitHub](https://github.com/brainiak/brainiak) (👨‍💻 35 · 🔀 140 · 📋 230 - 38% open · ⏱️ 06.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/brainiak) (📥 2.2K / month · ⏱️ 07.01.2025):
	```
...
- <b><a href="https://github.com/nipy/nipy">NIPY</a></b> (🥉23 ·  ⭐ 400 · 💤) - Neuroimaging in Python FMRI analysis package. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/perone/medicaltorch">MedicalTorch</a></b> (🥉16 ·  ⭐ 870 · 💀) - A medical imaging framework for Pytorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/skrub-data/skrub) (👨‍💻 77 · 🔀 160 · 📦 100 · 📋 570 - 22% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/skrub-data/skrub
	```
- [PyPi](https://pypi.org/project/skrub) (📥 47K / month · 📦 20 · ⏱️ 25.09.2025):
	```
	pip install skrub
	```
</details>
...
- [GitHub](https://github.com/manujosephv/pytorch_tabular) (👨‍💻 27 · 🔀 160 · 📥 64 · 📋 180 - 5% open · ⏱️ 19.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytorch_tabular) (📥 5.8K / month · 📦 9 · ⏱️ 28.11.2024):
	```
	pip install pytorch_tabular
	```
</details>
<details><summary><b><a href="https://github.com/AnotherSamWilson/miceforest">miceforest</a></b> (🥈21 ·  ⭐ 390 · 📈) - Multiple Imputation with LightGBM in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/AnotherSamWilson/miceforest) (👨‍💻 9 · 🔀 32 · 📋 91 - 9% open · ⏱️ 19.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/miceforest) (📥 29K / month · 📦 9 · ⏱️ 02.08.2024):
	```
...
<details><summary><b><a href="https://github.com/PaddlePaddle/PaddleOCR">PaddleOCR</a></b> (🥇44 ·  ⭐ 61K · 📈) - Turn any PDF or image document into structured data for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PaddlePaddle/PaddleOCR) (👨‍💻 310 · 🔀 9K · 📥 2M · 📦 6.2K · 📋 10K - 1% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/PaddlePaddle/PaddleOCR
	```
- [PyPi](https://pypi.org/project/paddleocr) (📥 710K / month · 📦 200 · ⏱️ 16.10.2025):
	```
...
- [GitHub](https://github.com/ocrmypdf/OCRmyPDF) (👨‍💻 120 · 🔀 2.2K · 📥 15K · 📦 1.4K · 📋 1.3K - 11% open · ⏱️ 16.10.2025):

	```
	git clone https://github.com/ocrmypdf/OCRmyPDF
	```
- [PyPi](https://pypi.org/project/ocrmypdf) (📥 390K / month · 📦 58 · ⏱️ 16.10.2025):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 50 · 🔀 730 · 📋 370 - 3% open · ⏱️ 17.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 5.4M / month · 📦 970 · ⏱️ 16.08.2024):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 34 · 🔀 260 · 📥 1.1K · 📦 1.3K · 📋 290 - 14% open · ⏱️ 10.10.2025):
...
- [GitHub](https://github.com/open-mmlab/mmocr) (👨‍💻 90 · 🔀 770 · 📦 240 · 📋 930 - 20% open · ⏱️ 27.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/mmocr) (📥 5.1K / month · 📦 4 · ⏱️ 05.05.2022):
	```
	pip install mmocr
	```
</details>
...
- [GitHub](https://github.com/ray-project/ray) (👨‍💻 1.4K · 🔀 6.8K · 📥 270 · 📦 27K · 📋 22K - 14% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/ray-project/ray
	```
- [PyPi](https://pypi.org/project/ray) (📥 30M / month · 📦 1.1K · ⏱️ 18.10.2025):
	```
	pip install ray
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 630 · 🔀 1.8K · 📦 77K · 📋 5.6K - 21% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 19M / month · 📦 3.2K · ⏱️ 14.10.2025):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/deepspeedai/DeepSpeed) (👨‍💻 420 · 🔀 4.6K · 📦 15K · 📋 3.2K - 34% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/microsoft/DeepSpeed
	```
- [PyPi](https://pypi.org/project/deepspeed) (📥 1M / month · 📦 340 · ⏱️ 07.10.2025):
	```
...
- [GitHub](https://github.com/dask/distributed) (👨‍💻 340 · 🔀 740 · 📦 42K · 📋 3.9K - 37% open · ⏱️ 16.10.2025):
...
- [GitHub](https://github.com/horovod/horovod) (👨‍💻 180 · 🔀 2.3K · 📦 1.4K · 📋 2.3K - 17% open · ⏱️ 31.07.2025):

	```
	git clone https://github.com/horovod/horovod
	```
- [PyPi](https://pypi.org/project/horovod) (📥 76K / month · 📦 34 · ⏱️ 12.06.2023):
	```
	pip install horovod
	```
</details>
...
- [GitHub](https://github.com/Lightning-AI/torchmetrics) (👨‍💻 280 · 🔀 460 · 📥 6.9K · 📦 45K · 📋 980 - 8% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/metrics) (📥 4.1K / month · 📦 4 · ⏱️ 26.02.2025):
	```
	pip install metrics
	```
...
- [GitHub](https://github.com/mpi4py/mpi4py) (👨‍💻 28 · 🔀 130 · 📥 39K · 📦 12K · 📋 220 - 1% open · ⏱️ 18.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/mpi4py) (📥 940K / month · 📦 1K · ⏱️ 10.10.2025):
	```
	pip install mpi4py
	```
...
- [GitHub](https://github.com/facebookresearch/fairscale) (👨‍💻 77 · 🔀 290 · 📦 9K · 📋 390 - 26% open · ⏱️ 26.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fairscale) (📥 570K / month · 📦 150 · ⏱️ 11.12.2022):
	```
...
- [GitHub](https://github.com/intel/ipex-llm) (👨‍💻 120 · 🔀 1.4K · 📥 710 · 📋 3K - 40% open · ⏱️ 14.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/bigdl) (📥 18K / month · 📦 2 · ⏱️ 24.03.2024):
	```
	pip install bigdl
	```
...
- [GitHub](https://github.com/microsoft/SynapseML) (👨‍💻 130 · 🔀 850 · 📋 820 - 49% open · ⏱️ 14.10.2025):

	```
	git clone https://github.com/microsoft/SynapseML
	```
- [PyPi](https://pypi.org/project/synapseml) (📥 1.7M / month · 📦 7 · ⏱️ 03.10.2025):
	```
...
- [GitHub](https://github.com/dask/dask-ml) (👨‍💻 82 · 🔀 260 · 📦 1.3K · 📋 550 - 51% open · ⏱️ 27.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/dask-ml) (📥 130K / month · 📦 100 · ⏱️ 08.02.2025):
	```
	pip install dask-ml
	```
...
- [GitHub](https://github.com/learning-at-home/hivemind) (👨‍💻 34 · 🔀 190 · 📦 130 · 📋 190 - 43% open · ⏱️ 12.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/hivemind) (📥 48K / month · 📦 12 · ⏱️ 20.04.2025):
	```
...
- [GitHub](https://github.com/intel/analytics-zoo) (👨‍💻 110 · 🔀 730 · 📋 1.3K - 32% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/analytics-zoo) (📥 660 / month · 📦 1 · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/optuna/optuna) (👨‍💻 320 · 🔀 1.2K · 📦 30K · 📋 1.8K - 3% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/facebook/Ax) (👨‍💻 200 · 🔀 350 · 📦 1.2K · 📋 930 - 12% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 140 · 🔀 1.1K · 📦 1.2K · 📋 1.8K - 24% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/autogluon/autogluon
	```
- [PyPi](https://pypi.org/project/autogluon) (📥 270K / month · 📦 38 · ⏱️ 23.10.2025):
	```
...
- [GitHub](https://github.com/meta-pytorch/botorch) (👨‍💻 150 · 🔀 440 · 📦 1.8K · 📋 620 - 14% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/pytorch/botorch
	```
- [PyPi](https://pypi.org/project/botorch) (📥 480K / month · 📦 130 · ⏱️ 12.08.2025):
	```
	pip install botorch
	```
...
- [GitHub](https://github.com/alteryx/featuretools) (👨‍💻 75 · 🔀 900 · 📦 2.1K · 📋 1K - 15% open · ⏱️ 13.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/featuretools) (📥 110K / month · 📦 74 · ⏱️ 14.05.2024):
	```
...
- [GitHub](https://github.com/facebookresearch/nevergrad) (👨‍💻 58 · 🔀 360 · 📦 1.2K · 📋 310 - 40% open · ⏱️ 23.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/nevergrad) (📥 160K / month · 📦 72 · ⏱️ 23.04.2025):
	```
...
- [GitHub](https://github.com/mljar/mljar-supervised) (👨‍💻 30 · 🔀 420 · 📦 170 · 📋 680 - 21% open · ⏱️ 07.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/mljar-supervised) (📥 8.5K / month · 📦 6 · ⏱️ 07.07.2025):
	```
...
- [GitHub](https://github.com/SimonBlanke/Hyperactive) (👨‍💻 15 · 🔀 51 · 📥 330 · 📦 40 · 📋 120 - 29% open · ⏱️ 30.09.2025):

	```
	git clone https://github.com/SimonBlanke/Hyperactive
	```
- [PyPi](https://pypi.org/project/hyperactive) (📥 4.8K / month · 📦 13 · ⏱️ 20.09.2025):
	```
...
- [GitHub](https://github.com/aimclub/FEDOT) (👨‍💻 40 · 🔀 88 · 📦 65 · 📋 570 - 11% open · ⏱️ 14.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/fedot) (📥 2.6K / month · 📦 7 · ⏱️ 10.03.2025):
	```
	pip install fedot
	```
</details>
...
- [GitHub](https://github.com/ScottfreeLLC/AlphaPy) (👨‍💻 5 · 🔀 250 · 📦 10 · 📋 45 - 35% open · ⏱️ 24.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/alphapy) (📥 360 / month · ⏱️ 29.08.2020):
	```
	pip install alphapy
	```
</details>
...
- [GitHub](https://github.com/AutoViML/Auto_ViML) (👨‍💻 9 · 🔀 100 · 📦 28 · ⏱️ 30.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/autoviml) (📥 3.3K / month · 📦 3 · ⏱️ 30.01.2025):
	```
...
- [GitHub](https://github.com/AutoViML/featurewiz) (👨‍💻 18 · 🔀 98 · 📋 110 - 0% open · ⏱️ 19.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/featurewiz) (📥 5.4K / month · 📦 4 · ⏱️ 19.02.2025):
	```
...
- <b><a href="https://github.com/nidhaloff/igel">igel</a></b> (🥉20 ·  ⭐ 3.1K · 💀) - a delightful machine learning tool that allows you to train, test, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/AI4Finance-Foundation/FinRL) (👨‍💻 130 · 🔀 2.9K · 📦 110 · 📋 760 - 35% open · ⏱️ 03.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/finrl) (📥 2.6K / month · ⏱️ 08.01.2022):
	```
	pip install finrl
	```
</details>
...
- [GitHub](https://github.com/Farama-Foundation/ViZDoom) (👨‍💻 57 · 🔀 400 · 📥 12K · 📦 340 · 📋 470 - 6% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/vizdoom) (📥 7.7K / month · 📦 20 · ⏱️ 22.10.2025):
	```
	pip install vizdoom
	```
</details>
...
- [GitHub](https://github.com/google-deepmind/acme) (👨‍💻 90 · 🔀 500 · 📦 250 · 📋 270 - 24% open · ⏱️ 26.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/dm-acme) (📥 9K / month · 📦 3 · ⏱️ 10.02.2022):
	```
	pip install dm-acme
	```
...
- [GitHub](https://github.com/google/dopamine) (👨‍💻 15 · 🔀 1.4K · 📦 21 · 📋 200 - 55% open · ⏱️ 04.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/dopamine-rl) (📥 87K / month · 📦 10 · ⏱️ 31.10.2024):
	```
...
- [GitHub](https://github.com/tensorflow/agents) (👨‍💻 150 · 🔀 740 · 📋 680 - 30% open · ⏱️ 16.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/tf-agents) (📥 49K / month · 📦 14 · ⏱️ 14.12.2023):
	```
...
- [GitHub](https://github.com/google-deepmind/rlax) (👨‍💻 23 · 🔀 94 · 📦 370 · 📋 27 - 29% open · ⏱️ 26.09.2025):

	```
	git clone https://github.com/deepmind/rlax
	```
- [PyPi](https://pypi.org/project/rlax) (📥 53K / month · 📦 22 · ⏱️ 01.09.2025):
	```
	pip install rlax
	```
</details>
<details><summary><b><a href="https://github.com/PaddlePaddle/PARL">PARL</a></b> (🥉25 ·  ⭐ 3.4K) - A high-performance distributed training framework for Reinforcement.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1M" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PaddlePaddle/PARL) (👨‍💻 46 · 🔀 820 · 📦 140 · 📋 540 - 23% open · ⏱️ 13.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/parl) (📥 2.2K / month · 📦 1 · ⏱️ 13.05.2022):
	```
	pip install parl
	```
</details>
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 170 · 🔀 520 · 📋 160 - 53% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/reagent) (📥 42 / month · ⏱️ 27.05.2020):
	```
	pip install reagent
	```
</details>
...
- <b><a href="https://github.com/tensorlayer/TensorLayer">TensorLayer</a></b> (🥈28 ·  ⭐ 7.4K · 💀) - Deep Learning and Reinforcement Learning Library for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- <b><a href="https://github.com/hill-a/stable-baselines">Stable Baselines</a></b> (🥉25 ·  ⭐ 4.3K · 💀) - A fork of OpenAI Baselines, implementations of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/recommenders-team/recommenders) (👨‍💻 140 · 🔀 3.2K · 📥 790 · 📦 180 · 📋 890 - 18% open · ⏱️ 13.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/recommenders) (📥 14K / month · 📦 4 · ⏱️ 24.12.2024):
	```
...
- [GitHub](https://github.com/meta-pytorch/torchrec) (👨‍💻 390 · 🔀 560 · 📦 240 · 📋 320 - 49% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/pytorch/torchrec
	```
- [PyPi](https://pypi.org/project/torchrec-nightly-cpu) (📥 540 / month · ⏱️ 12.05.2022):
	```
...
- [GitHub](https://github.com/PreferredAI/cornac) (👨‍💻 25 · 🔀 160 · 📦 300 · 📋 170 - 17% open · ⏱️ 04.10.2025):

	```
	git clone https://github.com/PreferredAI/cornac
	```
- [PyPi](https://pypi.org/project/cornac) (📥 39K / month · 📦 18 · ⏱️ 04.10.2025):
	```
	pip install cornac
	```
...
- [GitHub](https://github.com/lenskit/lkpy) (👨‍💻 41 · 🔀 72 · 📦 140 · 📋 280 - 33% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/lenskit/lkpy
	```
- [PyPi](https://pypi.org/project/lenskit) (📥 6.8K / month · 📦 13 · ⏱️ 22.10.2025):
	```
	pip install lenskit
	```
- [Conda](https://anaconda.org/conda-forge/lenskit) (📥 51K · ⏱️ 23.10.2025):
	```
...
- [GitHub](https://github.com/RUCAIBox/RecBole) (👨‍💻 79 · 🔀 690 · 📋 1K - 30% open · ⏱️ 24.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/recbole) (📥 110K / month · 📦 2 · ⏱️ 24.02.2025):
	```
	pip install recbole
	```
...
- [GitHub](https://github.com/OpenMined/PySyft) (👨‍💻 520 · 🔀 2K · 📥 2.1K · 📦 1 · 📋 3.4K - 1% open · ⏱️ 13.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/syft) (📥 27K / month · 📦 5 · ⏱️ 13.04.2025):
	```
	pip install syft
	```
</details>
...
- [GitHub](https://github.com/meta-pytorch/opacus) (👨‍💻 87 · 🔀 370 · 📥 150 · 📦 1.2K · 📋 340 - 19% open · ⏱️ 16.09.2025):
...
- [GitHub](https://github.com/tensorflow/privacy) (👨‍💻 60 · 🔀 450 · 📥 190 · 📋 210 - 55% open · ⏱️ 13.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-privacy) (📥 23K / month · 📦 21 · ⏱️ 14.02.2024):
	```
...
- [GitHub](https://github.com/facebookresearch/CrypTen) (👨‍💻 40 · 🔀 290 · 📋 280 - 28% open · ⏱️ 23.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/crypten) (📥 990 / month · 📦 1 · ⏱️ 08.12.2022):
	```
	pip install crypten
	```
</details>
...
- [GitHub](https://github.com/mlflow/mlflow) (👨‍💻 910 · 🔀 4.9K · 📦 66K · 📋 5.2K - 39% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/mlflow/mlflow
	```
- [PyPi](https://pypi.org/project/mlflow) (📥 25M / month · 📦 1.3K · ⏱️ 22.10.2025):
	```
	pip install mlflow
	```
- [Conda](https://anaconda.org/conda-forge/mlflow) (📥 3.6M · ⏱️ 22.10.2025):
	```
...
- [GitHub](https://github.com/wandb/wandb) (👨‍💻 220 · 🔀 780 · 📥 1.2K · 📦 84K · 📋 3.7K - 18% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/wandb/client
	```
- [PyPi](https://pypi.org/project/wandb) (📥 21M / month · 📦 2.3K · ⏱️ 29.09.2025):
	```
	pip install wandb
	```
...
- [GitHub](https://github.com/iterative/dvc) (👨‍💻 320 · 🔀 1.2K · 📦 24K · 📋 4.9K - 4% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/iterative/dvc
	```
- [PyPi](https://pypi.org/project/dvc) (📥 1.4M / month · 📦 140 · ⏱️ 02.09.2025):
	```
	pip install dvc
	```
...
- [GitHub](https://github.com/tensorflow/tensorboard) (👨‍💻 330 · 🔀 1.7K · 📦 330K · 📋 2K - 36% open · ⏱️ 12.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorboard) (📥 30M / month · 📦 2.8K · ⏱️ 17.07.2025):
	```
...
- [GitHub](https://github.com/aws/sagemaker-python-sdk) (👨‍💻 500 · 🔀 1.2K · 📦 6.2K · 📋 1.6K - 21% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/aws/sagemaker-python-sdk
	```
- [PyPi](https://pypi.org/project/sagemaker) (📥 27M / month · 📦 210 · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/Netflix/metaflow) (👨‍💻 120 · 🔀 930 · 📦 950 · 📋 840 - 43% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/Netflix/metaflow
	```
- [PyPi](https://pypi.org/project/metaflow) (📥 720K / month · 📦 53 · ⏱️ 20.10.2025):
	```
...
- [GitHub](https://github.com/lanpa/tensorboardX) (👨‍💻 85 · 🔀 860 · 📥 500 · 📦 60K · 📋 470 - 18% open · ⏱️ 13.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorboardX) (📥 4.6M / month · 📦 740 · ⏱️ 10.06.2025):
	```
...
- [GitHub](https://github.com/pycaret/pycaret) (👨‍💻 140 · 🔀 1.8K · 📥 730 · 📦 7.9K · 📋 2.3K - 16% open · ⏱️ 06.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/pycaret) (📥 320K / month · 📦 31 · ⏱️ 28.04.2024):
	```
	pip install pycaret
	```
...
- [GitHub](https://github.com/clearml/clearml) (👨‍💻 100 · 🔀 710 · 📥 3.5K · 📦 1.9K · 📋 1.2K - 44% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/allegroai/clearml
	```
- [PyPi](https://pypi.org/project/clearml) (📥 490K / month · 📦 78 · ⏱️ 22.10.2025):
	```
	pip install clearml
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 390 · 🔀 610 · 📦 2.5K · 📋 2.1K - 58% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/snakemake/snakemake
	```
- [PyPi](https://pypi.org/project/snakemake) (📥 140K / month · 📦 320 · ⏱️ 22.10.2025):
	```
...
<details><summary><b><a href="https://github.com/Kaggle/kaggle-api">kaggle</a></b> (🥈32 ·  ⭐ 6.9K) - Official Kaggle API. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/Kaggle/kaggle-api) (👨‍💻 49 · 🔀 1.2K · 📦 21 · 📋 530 - 27% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/Kaggle/kaggle-api
	```
- [PyPi](https://pypi.org/project/kaggle) (📥 720K / month · 📦 240 · ⏱️ 08.05.2025):
	```
	pip install kaggle
	```
...
- [GitHub](https://github.com/PaddlePaddle/VisualDL) (👨‍💻 36 · 🔀 630 · 📥 540 · 📦 3.6K · 📋 510 - 30% open · ⏱️ 22.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/visualdl) (📥 180K / month · 📦 82 · ⏱️ 30.10.2024):
	```
...
- [GitHub](https://github.com/IDSIA/sacred) (👨‍💻 110 · 🔀 390 · 📦 3.6K · 📋 560 - 18% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/sacred) (📥 52K / month · 📦 60 · ⏱️ 26.11.2024):
	```
	pip install sacred
	```
...
- [GitHub](https://github.com/neptune-ai/neptune-client) (👨‍💻 57 · 🔀 65 · 📦 920 · 📋 260 - 12% open · ⏱️ 09.06.2025):

	```
	git clone https://github.com/neptune-ai/neptune-client
	```
- [PyPi](https://pypi.org/project/neptune-client) (📥 500K / month · 📦 77 · ⏱️ 15.04.2025):
	```
...
- [GitHub](https://github.com/meta-pytorch/tnt) (👨‍💻 150 · 🔀 290 · 📋 150 - 56% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/torchnet) (📥 12K / month · 📦 24 · ⏱️ 29.07.2018):
	```
...
- [GitHub](https://github.com/google/ml-metadata) (👨‍💻 23 · 🔀 170 · 📥 3K · 📦 720 · 📋 130 - 41% open · ⏱️ 03.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/ml-metadata) (📥 49K / month · 📦 32 · ⏱️ 07.04.2025):
	```
...
- [GitHub](https://github.com/labmlai/labml) (👨‍💻 9 · 🔀 140 · 📦 240 · 📋 50 - 12% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/labml) (📥 7K / month · 📦 14 · ⏱️ 15.09.2024):
	```
	pip install labml
	```
</details>
<details><summary><b><a href="https://github.com/mrpowers-io/quinn">quinn</a></b> (🥉24 ·  ⭐ 670 · 💤) - pyspark methods to enhance developer productivity. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1N" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mrpowers-io/quinn) (👨‍💻 31 · 🔀 98 · 📥 69 · 📦 94 · 📋 130 - 27% open · ⏱️ 06.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/quinn) (📥 730K / month · 📦 7 · ⏱️ 13.02.2024):
	```
	pip install quinn
	```
</details>
...
- [GitHub](https://github.com/m3dev/gokart) (👨‍💻 48 · 🔀 63 · 📦 85 · 📋 100 - 31% open · ⏱️ 18.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/gokart) (📥 6.5K / month · 📦 8 · ⏱️ 18.06.2025):
	```
	pip install gokart
	```
</details>
...
- [GitHub](https://github.com/guildai/guildai) (👨‍💻 30 · 🔀 90 · 📥 32 · 📦 110 · 📋 440 - 50% open · ⏱️ 29.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/guildai) (📥 2.2K / month · ⏱️ 11.05.2022):
	```
	pip install guildai
	```
</details>
...
- [GitHub](https://github.com/microsoft/tensorwatch) (👨‍💻 15 · 🔀 360 · 📦 160 · 📋 70 - 75% open · ⏱️ 27.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorwatch) (📥 1.8K / month · 📦 7 · ⏱️ 04.03.2020):
	```
...
- [GitHub](https://github.com/replicate/keepsake) (👨‍💻 18 · 🔀 71 · 📋 190 - 65% open · ⏱️ 03.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/keepsake) (📥 900 / month · 📦 1 · ⏱️ 25.01.2021):
	```
...
- [GitHub](https://github.com/datmo/datmo) (👨‍💻 6 · 🔀 30 · 📦 7 · 📋 180 - 17% open · ⏱️ 23.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/datmo) (📥 190 / month · ⏱️ 07.12.2018):
	```
	pip install datmo
	```
</details>
...
- [GitHub]():
	...
	```
- [PyPi](https://pypi.org/project/comet_ml) (📥 560K / month · 📦 99 · ⏱️ 15.10.2025):
	```
...
- [GitHub](https://github.com/triton-lang/triton) (👨‍💻 480 · 🔀 2.3K · 📥 1.3K · 📦 74K · 📋 1.9K - 41% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 40M / month · 📦 540 · ⏱️ 13.10.2025):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/onnx/onnx) (👨‍💻 360 · 🔀 3.8K · 📥 25K · 📦 49K · 📋 3.1K - 9% open · ⏱️ 21.10.2025):
...
- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 280 · 🔀 820 · 📋 1.3K - 11% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/huggingface/huggingface_hub
	```
- [PyPi](https://pypi.org/project/huggingface_hub) (📥 120M / month · 📦 4.1K · ⏱️ 23.10.2025):
	```
...
- [GitHub](https://github.com/bentoml/BentoML) (👨‍💻 260 · 🔀 870 · 📥 120 · 📦 2.8K · 📋 1.1K - 12% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/bentoml/BentoML
	```
- [PyPi](https://pypi.org/project/bentoml) (📥 150K / month · 📦 44 · ⏱️ 20.10.2025):
	```
	pip install bentoml
	```
</details>
...
- [GitHub](https://github.com/apple/coremltools) (👨‍💻 200 · 🔀 710 · 📥 15K · 📦 5.1K · 📋 1.6K - 26% open · ⏱️ 22.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/coremltools) (📥 1.2M / month · 📦 110 · ⏱️ 28.07.2025):
	```
...
- [GitHub](https://github.com/pytorch/serve) (👨‍💻 220 · 🔀 890 · 📥 8K · 📦 900 · 📋 1.7K - 25% open · ⏱️ 17.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/torchserve) (📥 100K / month · 📦 26 · ⏱️ 30.09.2024):
	```
...
- [GitHub](https://github.com/microsoft/MMdnn) (👨‍💻 86 · 🔀 960 · 📥 4K · 📦 160 · 📋 630 - 53% open · ⏱️ 07.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/mmdnn) (📥 360 / month · ⏱️ 24.07.2020):
	```
	pip install mmdnn
	```
</details>
...
- [GitHub](https://github.com/riga/tfdeploy) (👨‍💻 4 · 🔀 38 · 📋 34 - 32% open · ⏱️ 04.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/tfdeploy) (📥 130 / month · ⏱️ 30.03.2017):
	```
...
- <b><a href="https://github.com/cog-imperial/OMLT">OMLT</a></b> (🥉19 ·  ⭐ 330) - Represent trained machine learning models as Pyomo optimization.. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/shap/shap) (👨‍💻 280 · 🔀 3.4K · 📦 35K · 📋 2.7K - 23% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/shap) (📥 9.4M / month · 📦 1.2K · ⏱️ 14.10.2025):
	```
	pip install shap
	```
...
- [GitHub](https://github.com/arviz-devs/arviz) (👨‍💻 180 · 🔀 460 · 📥 190 · 📦 11K · 📋 900 - 19% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/arviz) (📥 3.6M / month · 📦 410 · ⏱️ 09.07.2025):
	```
	pip install arviz
	```
...
- [GitHub](https://github.com/lutzroeder/netron) (👨‍💻 2 · 🔀 3K · 📥 110K · 📦 13 · 📋 1.2K - 1% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/lutzroeder/netron
	```
- [PyPi](https://pypi.org/project/netron) (📥 44K / month · 📦 92 · ⏱️ 23.10.2025):
	```
	pip install netron
	```
</details>
...
- [GitHub](https://github.com/huggingface/evaluate) (👨‍💻 130 · 🔀 290 · 📦 24K · 📋 390 - 62% open · ⏱️ 25.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/evaluate) (📥 3.7M / month · 📦 660 · ⏱️ 18.09.2025):
	```
...
- [GitHub](https://github.com/interpretml/interpret) (👨‍💻 53 · 🔀 770 · 📦 930 · 📋 490 - 22% open · ⏱️ 12.10.2025):

	```
	git clone https://github.com/interpretml/interpret
	```
- [PyPi](https://pypi.org/project/interpret) (📥 220K / month · 📦 58 · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/meta-pytorch/captum) (👨‍💻 140 · 🔀 540 · 📦 3.5K · 📋 610 - 41% open · ⏱️ 22.10.2025):
...
- [GitHub](https://github.com/fairlearn/fairlearn) (👨‍💻 100 · 🔀 470 · 📦 3 · 📋 530 - 26% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/py-why/dowhy) (👨‍💻 100 · 🔀 980 · 📥 43 · 📦 660 · 📋 510 - 27% open · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/dowhy) (📥 81K / month · 📦 28 · ⏱️ 12.07.2025):
	```
	pip install dowhy
	```
...
- [GitHub](https://github.com/oegedijk/explainerdashboard) (👨‍💻 23 · 🔀 340 · 📦 650 · 📋 240 - 16% open · ⏱️ 01.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/explainerdashboard) (📥 44K / month · 📦 15 · ⏱️ 03.06.2025):
	```
...
- [GitHub](https://github.com/tensorflow/model-analysis) (👨‍💻 61 · 🔀 280 · 📋 97 - 39% open · ⏱️ 06.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-model-analysis) (📥 160K / month · 📦 20 · ⏱️ 23.06.2025):
	```
...
- [GitHub](https://github.com/Trusted-AI/AIF360) (👨‍💻 73 · 🔀 870 · 📦 740 · 📋 300 - 65% open · ⏱️ 16.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/aif360) (📥 33K / month · 📦 32 · ⏱️ 08.04.2024):
	```
	pip install aif360
	```
...
- [GitHub](https://github.com/csinva/imodels) (👨‍💻 27 · 🔀 130 · 📦 130 · 📋 98 - 38% open · ⏱️ 26.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/imodels) (📥 32K / month · 📦 12 · ⏱️ 26.08.2025):
	```
	pip install imodels
	```
</details>
...
- [GitHub](https://github.com/PAIR-code/lit) (👨‍💻 38 · 🔀 360 · 📋 210 - 57% open · ⏱️ 20.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/lit-nlp) (📥 10K / month · 📦 3 · ⏱️ 20.12.2024):
	```
	pip install lit-nlp
	```
...
- [GitHub](https://github.com/Trusted-AI/AIX360) (👨‍💻 41 · 🔀 310 · 📦 170 · 📋 86 - 62% open · ⏱️ 26.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/aix360) (📥 2.3K / month · 📦 1 · ⏱️ 31.07.2023):
	```
	pip install aix360
	```
</details>
...
- [GitHub](https://github.com/philipperemy/keract) (👨‍💻 17 · 🔀 190 · 📦 260 · 📋 89 - 3% open · ⏱️ 07.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/keract) (📥 9.4K / month · 📦 7 · ⏱️ 07.04.2025):
	```
	pip install keract
	```
</details>
...
- [GitHub](https://github.com/interpretml/DiCE) (👨‍💻 23 · 🔀 210 · 📋 190 - 49% open · ⏱️ 13.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/dice-ml) (📥 56K / month · 📦 13 · ⏱️ 13.07.2025):
	```
	pip install dice-ml
	```
</details>
...
- [GitHub](https://github.com/parrt/random-forest-importances) (👨‍💻 16 · 🔀 130 · 📋 39 - 20% open · ⏱️ 24.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/rfpimp) (📥 18K / month · 📦 5 · ⏱️ 28.01.2021):
	```
	pip install rfpimp
	```
</details>
...
- <b><a href="https://github.com/kundajelab/deeplift">deeplift</a></b> (🥉22 ·  ⭐ 860 · 💀) - Public facing deeplift repo. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
<details><summary><b><a href="https://github.com/milvus-io/milvus">Milvus</a></b> (🥇43 ·  ⭐ 38K · 📈) - Milvus is a high-performance, cloud-native vector database built.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/milvus-io/milvus) (👨‍💻 330 · 🔀 3.5K · 📥 280K · 📋 14K - 5% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/milvus-io/milvus
	```
- [PyPi](https://pypi.org/project/pymilvus) (📥 3.2M / month · 📦 350 · ⏱️ 19.09.2025):
	```
...
- [GitHub](https://github.com/facebookresearch/faiss) (👨‍💻 250 · 🔀 4K · 📦 5K · 📋 2.7K - 9% open · ⏱️ 21.10.2025):
...
- [GitHub](https://github.com/unum-cloud/USearch) (👨‍💻 81 · 🔀 230 · 📥 100K · 📦 210 · 📋 240 - 31% open · ⏱️ 10.10.2025):
...
- [PyPi](https://pypi.org/project/usearch) (📥 140K / month · 📦 44 · ⏱️ 04.09.2025):
	...
	pip install usearch
	```
- [npm](https://www.npmjs.com/package/usearch) (📥 19K / month · 📦 22 · ⏱️ 10.10.2025):
	```
	npm install usearch
	```
- [Docker Hub](https://hub.docker.com/r/unum/usearch) (📥 450 · ⭐ 1 · ⏱️ 10.10.2025):
	```
...
- [GitHub](https://github.com/nmslib/nmslib) (👨‍💻 49 · 🔀 460 · 📦 1.4K · 📋 440 - 20% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/nmslib) (📥 310K / month · 📦 67 · ⏱️ 23.10.2025):
	```
	pip install nmslib
	```
...
- [GitHub](https://github.com/lmcinnes/pynndescent) (👨‍💻 31 · 🔀 110 · 📦 13K · 📋 140 - 53% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pynndescent) (📥 2.4M / month · 📦 160 · ⏱️ 17.06.2024):
	```
...
<details><summary><b><a href="https://github.com/yahoojapan/NGT">NGT</a></b> (🥉23 ·  ⭐ 1.3K) - Nearest Neighbor Search with Neighborhood Graph and Tree for High-.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/yahoojapan/NGT) (👨‍💻 19 · 🔀 120 · 📋 150 - 18% open · ⏱️ 15.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/ngt) (📥 2.4K / month · 📦 12 · ⏱️ 26.02.2025):
	```
	pip install ngt
	```
</details>
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 530 · 🔀 2.1K · 📥 140 · 📦 7.7K · 📋 3.6K - 11% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/pymc-devs/pymc
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 350K / month · 📦 190 · ⏱️ 31.05.2024):
	```
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 850K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/tensorflow/probability) (👨‍💻 500 · 🔀 1.1K · 📦 4 · 📋 1.5K - 48% open · ⏱️ 22.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-probability) (📥 980K / month · 📦 620 · ⏱️ 08.11.2024):
	```
...
- [GitHub](https://github.com/cornellius-gp/gpytorch) (👨‍💻 140 · 🔀 580 · 📦 3.2K · 📋 1.4K - 28% open · ⏱️ 14.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/gpytorch) (📥 480K / month · 📦 250 · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/pgmpy/pgmpy) (👨‍💻 180 · 🔀 860 · 📥 680 · 📦 1.7K · 📋 1.1K - 27% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/pgmpy/pgmpy
	```
- [PyPi](https://pypi.org/project/pgmpy) (📥 140K / month · 📦 72 · ⏱️ 31.03.2025):
	```
	pip install pgmpy
	```
</details>
...
- [GitHub](https://github.com/pydata/patsy) (👨‍💻 23 · 🔀 100 · 📦 130K · 📋 160 - 46% open · ⏱️ 20.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/patsy) (📥 21M / month · 📦 680 · ⏱️ 20.10.2025):
	```
	pip install patsy
	```
...
- [GitHub](https://github.com/pyro-ppl/pyro) (👨‍💻 160 · 🔀 1K · 📋 1.1K - 24% open · ⏱️ 09.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyro-ppl) (📥 610K / month · 📦 190 · ⏱️ 02.06.2024):
	```
...
- [GitHub](https://github.com/SALib/SALib) (👨‍💻 54 · 🔀 250 · 📦 1.6K · 📋 350 - 18% open · ⏱️ 12.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/salib) (📥 240K / month · 📦 190 · ⏱️ 12.10.2025):
	```
	pip install salib
	```
...
- [GitHub](https://github.com/GPflow/GPflow) (👨‍💻 84 · 🔀 430 · 📦 790 · 📋 840 - 19% open · ⏱️ 29.05.2025):
	...
	```
- [PyPi](https://pypi.org/project/gpflow) (📥 44K / month · 📦 43 · ⏱️ 29.05.2025):
	```
	pip install gpflow
	```
...
- [GitHub](https://github.com/bambinos/bambi) (👨‍💻 47 · 🔀 140 · 📦 220 · 📋 450 - 20% open · ⏱️ 20.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/bambi) (📥 48K / month · 📦 14 · ⏱️ 21.12.2024):
	```
	pip install bambi
	```
...
- [GitHub](https://github.com/jmschrei/pomegranate) (👨‍💻 75 · 🔀 590 · 📋 800 - 4% open · ⏱️ 07.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/pomegranate) (📥 38K / month · 📦 67 · ⏱️ 07.02.2025):
	```
...
- [GitHub](https://github.com/maximtrp/scikit-posthocs) (👨‍💻 18 · 🔀 41 · 📥 67 · 📦 1.2K · 📋 72 - 6% open · ⏱️ 11.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/scikit-posthocs) (📥 130K / month · 📦 73 · ⏱️ 29.03.2025):
	```
...
- [PyPi](https://pypi.org/project/pandas-ta) (📥 290K / month · 📦 190 · ⏱️ 14.09.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandas-ta) (📥 38K · ⏱️ 23.09.2025):
	```
...
- [GitHub](https://github.com/baal-org/baal) (👨‍💻 24 · 🔀 87 · 📦 67 · 📋 120 - 18% open · ⏱️ 07.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/baal) (📥 1.9K / month · 📦 2 · ⏱️ 24.06.2025):
	```
	pip install baal
	```
...
<details><summary><b><a href="https://github.com/ENSTA-U2IS-AI/torch-uncertainty">TorchUncertainty</a></b> (🥉22 ·  ⭐ 440) - Open-source framework for uncertainty and deep.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ENSTA-U2IS-AI/torch-uncertainty) (👨‍💻 13 · 🔀 35 · 📋 67 - 23% open · ⏱️ 31.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/torch-uncertainty) (📥 1K / month · 📦 4 · ⏱️ 31.07.2025):
	```
...
- [GitHub](https://github.com/uber/orbit) (👨‍💻 21 · 🔀 140 · 📋 410 - 13% open · ⏱️ 05.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/orbit-ml) (📥 28K / month · 📦 1 · ⏱️ 01.04.2024):
	```
...
- [GitHub](https://github.com/mattjj/pyhsmm) (👨‍💻 14 · 🔀 170 · 📦 35 · 📋 100 - 39% open · ⏱️ 25.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyhsmm) (📥 520 / month · 📦 1 · ⏱️ 10.05.2017):
	```
	pip install pyhsmm
	```
</details>
...
- [GitHub](https://github.com/Trusted-AI/adversarial-robustness-toolbox) (👨‍💻 140 · 🔀 1.2K · 📦 770 · 📋 910 - 1% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/adversarial-robustness-toolbox) (📥 32K / month · 📦 25 · ⏱️ 07.07.2025):
	```
...
- [GitHub](https://github.com/QData/TextAttack) (👨‍💻 67 · 🔀 420 · 📦 420 · 📋 290 - 23% open · ⏱️ 10.07.2025):

	```
	git clone https://github.com/QData/TextAttack
	```
- [PyPi](https://pypi.org/project/textattack) (📥 9K / month · 📦 11 · ⏱️ 11.03.2024):
	```
...
- [GitHub](https://github.com/huggingface/optimum) (👨‍💻 150 · 🔀 600 · 📦 6.3K · 📋 860 - 30% open · ⏱️ 09.10.2025):

	```
	git clone https://github.com/huggingface/optimum
	```
- [PyPi](https://pypi.org/project/optimum) (📥 3.6M / month · 📦 270 · ⏱️ 09.10.2025):
	```
	pip install optimum
	```
...
- [GitHub](https://github.com/rapidsai/cudf) (👨‍💻 310 · 🔀 980 · 📦 64 · 📋 7.3K - 15% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/inducer/pycuda) (👨‍💻 83 · 🔀 290 · 📦 4K · 📋 290 - 29% open · ⏱️ 12.10.2025):

	```
	git clone https://github.com/inducer/pycuda
	```
- [PyPi](https://pypi.org/project/pycuda) (📥 68K / month · 📦 200 · ⏱️ 09.09.2025):
	```
	pip install pycuda
	```
...
- [GitHub](https://github.com/NVIDIA/apex) (👨‍💻 130 · 🔀 1.4K · 📦 3.3K · 📋 1.3K - 57% open · ⏱️ 03.10.2025):
...
- [GitHub](https://github.com/rapidsai/cuml) (👨‍💻 190 · 🔀 590 · 📋 3K - 31% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/rapidsai/cuml
	```
- [PyPi](https://pypi.org/project/cuml) (📥 2.6K / month · 📦 14 · ⏱️ 01.06.2020):
	```
	pip install cuml
	```
</details>
...
- [GitHub](https://github.com/wookayin/gpustat) (👨‍💻 17 · 🔀 280 · 📦 7.9K · 📋 130 - 22% open · ⏱️ 13.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/gpustat) (📥 1M / month · 📦 150 · ⏱️ 22.08.2023):
	```
	pip install gpustat
	```
...
- [GitHub](https://github.com/arrayfire/arrayfire) (👨‍💻 97 · 🔀 540 · 📥 9.5K · 📋 1.8K - 19% open · ⏱️ 28.07.2025):

	```
	git clone https://github.com/arrayfire/arrayfire
	```
- [PyPi](https://pypi.org/project/arrayfire) (📥 6.2K / month · 📦 13 · ⏱️ 22.02.2022):
	```
...
- [GitHub](https://github.com/rapidsai/cugraph) (👨‍💻 120 · 🔀 340 · 📋 1.9K - 6% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/rapidsai/cugraph
	```
- [PyPi](https://pypi.org/project/cugraph) (📥 620 / month · 📦 4 · ⏱️ 01.06.2020):
	```
	pip install cugraph
	```
...
- [GitHub](https://github.com/cupy/cupy) (👨‍💻 340 · 🔀 950):
	...
	```
- [PyPi](https://pypi.org/project/cupy) (📥 41K / month · 📦 400 · ⏱️ 18.08.2025):
	```
	pip install cupy
	```
...
- [GitHub](https://github.com/NVIDIA/DALI) (👨‍💻 99 · 🔀 650 · 📋 1.7K - 15% open · ⏱️ 23.10.2025):
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 35 · 🔀 160 · 📥 700 · 📋 230 - 32% open · ⏱️ 05.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/kp) (📥 1.9K / month · ⏱️ 20.01.2024):
	```
	pip install kp
	```
</details>
...
- [GitHub](https://github.com/tensorflow/model-optimization) (👨‍💻 87 · 🔀 320 · 📋 400 - 57% open · ⏱️ 07.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-model-optimization) (📥 830K / month · 📦 45 · ⏱️ 08.02.2024):
	```
...
- [GitHub](https://github.com/tensorflow/io) (👨‍💻 120 · 🔀 290 · 📋 660 - 44% open · ⏱️ 10.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-io) (📥 740K / month · 📦 61 · ⏱️ 01.07.2024):
	```
...
- [GitHub](https://github.com/tensorflow/transform) (👨‍💻 31 · 🔀 220 · 📋 220 - 17% open · ⏱️ 06.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-transform) (📥 260K / month · 📦 19 · ⏱️ 13.06.2025):
	```
...
- [GitHub](https://github.com/tensorflow/compression) (👨‍💻 24 · 🔀 260 · 📋 100 - 10% open · ⏱️ 19.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-compression) (📥 8.2K / month · 📦 2 · ⏱️ 02.02.2024):
	```
...
- [GitHub](https://github.com/tensorflow/cloud) (👨‍💻 29 · 🔀 92 · 📋 100 - 73% open · ⏱️ 01.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorflow-cloud) (📥 20K / month · 📦 7 · ⏱️ 17.06.2021):
	```
...
- <b><a href="https://github.com/keras-team/keras-preprocessing">Keras-Preprocessing</a></b> (🥉27 ·  ⭐ 1K · 💀) - Utilities for working with image data, text data, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1A" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/uxlfoundation/scikit-learn-intelex) (👨‍💻 86 · 🔀 180 · 📦 14K · 📋 250 - 16% open · ⏱️ 23.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/scikit-learn-intelex) (📥 94K / month · 📦 74 · ⏱️ 22.10.2025):
	```
...
<details><summary><b><a href="https://github.com/scikit-learn-contrib/imbalanced-learn">imbalanced-learn</a></b> (🥇33 ·  ⭐ 7K) - A Python Package to Tackle the Curse of Imbalanced.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1F" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/scikit-learn-contrib/imbalanced-learn) (👨‍💻 89 · 🔀 1.3K · 📋 630 - 8% open · ⏱️ 14.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/imbalanced-learn) (📥 16M / month · 📦 600 · ⏱️ 14.08.2025):
	```
...
- [GitHub](https://github.com/rasbt/mlxtend) (👨‍💻 110 · 🔀 880 · 📦 21K · 📋 500 - 29% open · ⏱️ 19.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/mlxtend) (📥 990K / month · 📦 200 · ⏱️ 26.01.2025):
	```
	pip install mlxtend
	```
...
- [GitHub](https://github.com/koaning/scikit-lego) (👨‍💻 69 · 🔀 120 · 📦 190 · 📋 340 - 9% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/scikit-lego) (📥 52K / month · 📦 13 · ⏱️ 15.09.2025):
	```
...
- [GitHub](https://github.com/guofei9987/scikit-opt) (👨‍💻 24 · 🔀 1K · 📦 280 · 📋 180 - 37% open · ⏱️ 31.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/scikit-opt) (📥 11K / month · 📦 15 · ⏱️ 14.01.2022):
	```
...
- [GitHub](https://github.com/trent-b/iterative-stratification) (👨‍💻 7 · 🔀 75 · 📦 620 · 📋 27 - 7% open · ⏱️ 12.10.2024):
	...
	```
- [PyPi](https://pypi.org/project/iterative-stratification) (📥 56K / month · 📦 15 · ⏱️ 12.10.2024):
	```
...
- [GitHub](https://github.com/scikit-tda/scikit-tda) (👨‍💻 6 · 🔀 54 · 📦 93 · 📋 23 - 17% open · ⏱️ 21.10.2025):

	```
	git clone https://github.com/scikit-tda/scikit-tda
	```
- [PyPi](https://pypi.org/project/scikit-tda) (📥 2.3K / month · ⏱️ 19.07.2024):
	```
...
- [GitHub](https://github.com/google-research/torchsde) (👨‍💻 9 · 🔀 210 · 📦 5.5K · 📋 84 - 36% open · ⏱️ 30.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/torchsde) (📥 4.4M / month · 📦 37 · ⏱️ 26.09.2023):
	```
...
- [GitHub](https://github.com/rusty1s/pytorch_scatter) (👨‍💻 34 · 🔀 200 · 📋 420 - 6% open · ⏱️ 12.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/torch-scatter) (📥 86K / month · 📦 150 · ⏱️ 06.10.2023):
	```
...
- [GitHub](https://github.com/rusty1s/pytorch_sparse) (👨‍💻 48 · 🔀 160 · 📋 300 - 10% open · ⏱️ 12.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/torch-sparse) (📥 70K / month · 📦 120 · ⏱️ 06.10.2023):
	```
...
- [GitHub](https://github.com/BloodAxe/pytorch-toolbelt) (👨‍💻 9 · 🔀 120 · 📥 180 · 📋 33 - 12% open · ⏱️ 09.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pytorch_toolbelt) (📥 9.6K / month · 📦 12 · ⏱️ 21.11.2024):
	```
...
- [GitHub](https://github.com/facebookresearch/madgrad) (👨‍💻 3 · 🔀 58 · 📦 110 · ⏱️ 27.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/madgrad) (📥 9K / month · 📦 1 · ⏱️ 08.03.2022):
	```
	pip install madgrad
	```
</details>
...
- <b><a href="https://github.com/karpathy/micrograd">micrograd</a></b> (🥉22 ·  ⭐ 13K · 💀) - A tiny scalar-valued autograd engine and a neural net library.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://git.io/JLy1Q" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.8K · 🔀 5.5K · 📥 110K · 📦 1.4M · 📋 11K - 15% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/scipy/scipy
	```
- [PyPi](https://pypi.org/project/scipy) (📥 210M / month · 📦 60K · ⏱️ 11.09.2025):
	```
	pip install scipy
	```
- [Conda](https://anaconda.org/conda-forge/scipy) (📥 70M · ⏱️ 12.09.2025):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.4K · 🔀 4.8K · 📥 570K · 📦 290K · 📋 15K - 37% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 71M / month · 📦 4.6K · ⏱️ 27.04.2025):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 700 · 🔀 3.1K · 📦 84K · 📋 6.1K - 6% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/gradio-app/gradio
	```
- [PyPi](https://pypi.org/project/gradio) (📥 10M / month · 📦 1.6K · ⏱️ 22.10.2025):
	```
	pip install gradio
	```
</details>
...
- [GitHub](https://github.com/carla-simulator/carla) (👨‍💻 190 · 🔀 4.2K · 📦 1.1K · 📋 6.2K - 18% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/carla-simulator/carla
	```
- [PyPi](https://pypi.org/project/carla) (📥 17K / month · 📦 16 · ⏱️ 14.09.2025):
	```
	pip install carla
	```
</details>
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 64 · 🔀 910 · 📦 14K · 📋 440 - 42% open · ⏱️ 20.10.2025):

	```
	git clone https://github.com/HIPS/autograd
	```
- [PyPi](https://pypi.org/project/autograd) (📥 3.5M / month · 📦 310 · ⏱️ 05.05.2025):
	```
...
- [GitHub](https://github.com/PennyLaneAI/pennylane) (👨‍💻 210 · 🔀 700 · 📥 100 · 📦 1.9K · 📋 1.7K - 25% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/PennyLaneAI/PennyLane
	```
- [PyPi](https://pypi.org/project/pennylane) (📥 220K / month · 📦 89 · ⏱️ 15.10.2025):
	```
...
<details><summary><b><a href="https://github.com/yzhao062/pyod">PyOD</a></b> (🥈35 ·  ⭐ 9.5K · 📉) - A Python Library for Outlier and Anomaly Detection, Integrating.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/yzhao062/pyod) (👨‍💻 64 · 🔀 1.4K · 📦 5.5K · 📋 390 - 59% open · ⏱️ 29.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyod) (📥 830K / month · 📦 130 · ⏱️ 29.04.2025):
	```
	pip install pyod
	```
...
- [GitHub](https://github.com/deepchem/deepchem) (👨‍💻 260 · 🔀 1.9K · 📦 650 · 📋 2.1K - 39% open · ⏱️ 07.10.2025):

	```
	git clone https://github.com/deepchem/deepchem
	```
- [PyPi](https://pypi.org/project/deepchem) (📥 60K / month · 📦 22 · ⏱️ 07.10.2025):
	```
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 82 · 🔀 770 · 📥 75 · 📦 1.6K · 📋 1.9K - 32% open · ⏱️ 22.10.2025):

	```
	git clone https://github.com/simonw/datasette
	```
- [PyPi](https://pypi.org/project/datasette) (📥 190K / month · 📦 480 · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/serge-sans-paille/pythran) (👨‍💻 75 · 🔀 200 · 📦 3.6K · 📋 930 - 15% open · ⏱️ 30.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/pythran) (📥 490K / month · 📦 28 · ⏱️ 23.05.2025):
	```
	pip install pythran
	```
- [Conda](https://anaconda.org/conda-forge/pythran) (📥 1.2M · ⏱️ 07.07.2025):
	```
...
- [GitHub](https://github.com/wireservice/agate) (👨‍💻 55 · 🔀 150 · 📦 5.3K · 📋 650 - 0% open · ⏱️ 05.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/agate) (📥 23M / month · 📦 54 · ⏱️ 29.01.2025):
	```
	pip install agate
	```
...
- [GitHub](https://github.com/online-ml/river) (👨‍💻 130 · 🔀 590 · 📦 800 · 📋 630 - 19% open · ⏱️ 05.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/river) (📥 100K / month · 📦 64 · ⏱️ 25.11.2024):
	```
	pip install river
	```
...
- [GitHub](https://github.com/open-edge-platform/anomalib) (👨‍💻 98 · 🔀 820 · 📥 41K · 📦 200 · 📋 1.2K - 5% open · ⏱️ 23.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/anomalib) (📥 140K / month · 📦 7 · ⏱️ 09.10.2025):
	```
...
- [GitHub](https://github.com/pyjanitor-devs/pyjanitor) (👨‍💻 110 · 🔀 170 · 📦 980 · 📋 590 - 18% open · ⏱️ 21.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pyjanitor) (📥 260K / month · 📦 42 · ⏱️ 07.03.2025):
	```
...
- [GitHub](https://github.com/uber/causalml) (👨‍💻 71 · 🔀 830 · 📦 310 · 📋 420 - 10% open · ⏱️ 26.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/causalml) (📥 70K / month · 📦 10 · ⏱️ 09.07.2025):
	```
...
- [GitHub](https://github.com/dstackai/dstack) (👨‍💻 62 · 🔀 200 · 📦 22 · 📋 1.5K - 7% open · ⏱️ 23.10.2025):

	```
	git clone https://github.com/dstackai/dstack
	```
- [PyPi](https://pypi.org/project/dstack) (📥 4.6K / month · ⏱️ 23.10.2025):
	```
	pip install dstack
	```
</details>
...
- [GitHub](https://github.com/dbt-labs/metricflow) (👨‍💻 52 · 🔀 130 · 📦 37 · 📋 370 - 27% open · ⏱️ 15.10.2025):

	```
	git clone https://github.com/transform-data/metricflow
	```
- [PyPi](https://pypi.org/project/metricflow) (📥 92K / month · 📦 4 · ⏱️ 14.10.2025):
	```
...
- [GitHub](https://github.com/sepandhaghighi/pycm) (👨‍💻 18 · 🔀 120 · 📦 420 · 📋 210 - 7% open · ⏱️ 14.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pycm) (📥 180K / month · 📦 28 · ⏱️ 15.10.2025):
	```
	pip install pycm
	```
</details>
...
- [GitHub](https://github.com/MaxHalford/prince) (👨‍💻 16 · 🔀 190 · 📦 770 · ⏱️ 04.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/prince) (📥 240K / month · 📦 23 · ⏱️ 04.08.2025):
	```
	pip install prince
	```
...
- [GitHub](https://github.com/google/trax) (👨‍💻 82 · 🔀 830 · 📦 230 · 📋 250 - 50% open · ⏱️ 26.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/trax) (📥 4.9K / month · 📦 1 · ⏱️ 26.10.2021):
	```
	pip install trax
	```
</details>
...
- [GitHub](https://github.com/adapter-hub/adapters) (👨‍💻 17 · 🔀 360 · 📦 250 · 📋 410 - 10% open · ⏱️ 12.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/adapter-transformers) (📥 6K / month · 📦 12 · ⏱️ 07.07.2024):
	```
...
- [GitHub](https://github.com/ContinualAI/avalanche) (👨‍💻 87 · 🔀 310 · 📥 60 · 📦 140 · 📋 840 - 13% open · ⏱️ 11.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/avalanche-lib) (📥 5K / month · 📦 3 · ⏱️ 29.10.2024):
	```
...
- [GitHub](https://github.com/trevorstephens/gplearn) (👨‍💻 12 · 🔀 300 · 📦 730 · 📋 220 - 11% open · ⏱️ 23.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/gplearn) (📥 25K / month · 📦 19 · ⏱️ 03.05.2022):
	```
	pip install gplearn
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/AugLy">AugLy</a></b> (🥉25 ·  ⭐ 5.1K) - A data augmentations library for audio, image, text, and video. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/AugLy) (👨‍💻 41 · 🔀 310 · 📦 180 · 📋 80 - 30% open · ⏱️ 17.10.2025):

	```
	git clone https://github.com/facebookresearch/AugLy
	```
- [PyPi](https://pypi.org/project/augly) (📥 4.1K / month · 📦 4 · ⏱️ 05.12.2023):
	```
	pip install augly
	```
</details>
...
- [GitHub](https://github.com/minrk/findspark) (👨‍💻 16 · 🔀 72 · 📦 5.6K · 📋 23 - 47% open · ⏱️ 04.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/findspark) (📥 2.7M / month · 📦 100 · ⏱️ 11.02.2022):
	```
...
- [GitHub](https://github.com/vecxoz/vecstack) (👨‍💻 1 · 🔀 82 · 📦 570 · ⏱️ 28.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/vecstack) (📥 1.9K / month · 📦 5 · ⏱️ 28.09.2025):
	```
...
- [GitHub](https://github.com/Project-MONAI/MONAILabel) (👨‍💻 69 · 🔀 240 · 📥 130K · 📋 560 - 26% open · ⏱️ 14.08.2025):
	...
	```
- [PyPi](https://pypi.org/project/monailabel-weekly) (📥 430 / month · ⏱️ 01.10.2023):
	```
...
- [GitHub](https://github.com/jmschrei/apricot) (👨‍💻 4 · 🔀 49 · 📥 33 · 📦 200 · 📋 34 - 38% open · ⏱️ 09.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/apricot-select) (📥 15K / month · 📦 16 · ⏱️ 18.02.2021):
	```
...
- [GitHub](https://github.com/pykale/pykale) (👨‍💻 28 · 🔀 70 · 📦 6 · 📋 140 - 8% open · ⏱️ 14.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/pykale) (📥 93 / month · ⏱️ 12.04.2022):
	```
	pip install pykale
	```
</details>
...
- [GitHub](https://github.com/infer-actively/pymdp) (👨‍💻 19 · 🔀 110 · 📋 120 - 41% open · ⏱️ 09.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/inferactively-pymdp) (📥 1.4K / month · ⏱️ 08.12.2022):
	```
...
- <b><a href="https://github.com/datalad/datalad">datalad</a></b> (🥈28 ·  ⭐ 610) - Keep code, data, containers under control with git and git-annex. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/Palashio/nylon">nylon</a></b> (🥉13 ·  ⭐ 83 · 💀) - An intelligent, flexible grammar of machine learning. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
</details>
